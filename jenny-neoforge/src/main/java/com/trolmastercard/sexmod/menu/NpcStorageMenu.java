...
public class NpcStorageMenu extends AbstractContainerMenu {
    private final Container a;

    public NpcStorageMenu(int var1, Inventory var2, ContainerGirlEntity var3) {
        this(var1, var2, (Container)var3);
    }

    public NpcStorageMenu(int var1, Inventory var2, int var3) {
        this(var1, var2, a(var2, var3));
    }

    private NpcStorageMenu(int var1, Inventory var2, Container var3) {
        super((MenuType)ModMenus.c.get(), var1);
        this.a = var3;
    ...
    private static Container a(Inventory var0, int var1) {
        return (Container)(var0.player.level().getEntity(var1) instanceof ContainerGirlEntity var3 ? var3 : new SimpleContainer(27));
    }
