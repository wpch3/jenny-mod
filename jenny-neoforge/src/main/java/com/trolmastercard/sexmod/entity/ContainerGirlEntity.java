...
public abstract class ContainerGirlEntity extends GirlEntity implements Container {
    public static final EntityDataAccessor<Boolean> d = SynchedEntityData.defineId(ContainerGirlEntity.class, EntityDataSerializers.BOOLEAN);
    public ItemStackHandler e = new ItemStackHandler(27);

    protected ContainerGirlEntity(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
    }
