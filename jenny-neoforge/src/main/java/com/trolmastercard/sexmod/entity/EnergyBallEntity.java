...
public class EnergyBallEntity extends Mob {
    ...
    boolean c = false;
    boolean d = true;
    com.trolmastercard.sexmod.entity.GalathEntity e;

    public EnergyBallEntity(EntityType<? extends Mob> var1, Level var2) {
        super(var1, var2);
    }

    public EnergyBallEntity(EntityType<? extends Mob> var1, Level var2, com.trolmastercard.sexmod.entity.GalathEntity var3, Vec3 var4) {
        this(var1, var2);
        this.b = var4;
        this.e = var3;
    }
    ...
    public void tick() {
        if (!this.isRemoved()) {
            ...
            if (this.level().isClientSide()) {
                this.a(
                    com.trolmastercard.sexmod.util.LerpUtils.a(this.xo, this.getX(), 0.5),
                    com.trolmastercard.sexmod.util.LerpUtils.a(this.yo, this.getY(), 0.5),
                    com.trolmastercard.sexmod.util.LerpUtils.a(this.zo, this.getZ(), 0.5)
                );
        ...
        if (!this.level().isClientSide()) {
            if (this.c) {
                ...
                if (!var3.isEmpty()) {
                    ...
                    for (com.trolmastercard.sexmod.entity.GalathEntity var5 : var3) {
