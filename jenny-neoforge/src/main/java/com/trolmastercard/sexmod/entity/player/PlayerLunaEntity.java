...
public class PlayerLunaEntity extends PlayerGirlEntity {
    int l = 0;
    boolean m = false;
    boolean n = false;
    boolean o = false;

    public PlayerLunaEntity(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
    }
    ...
    public boolean a(Player var1) {
        com.trolmastercard.sexmod.entity.GirlEntity.a(var1, this, new String[]{"action.names.touchboobs", "action.names.headpat"}, false);
        return true;
    }
    ...
    void a(Player var1, int var2) {
        ...
        if (var2 == 25) {
            Player var4 = com.trolmastercard.sexmod.client.ClientUtils.b();
    ...
    protected com.trolmastercard.sexmod.entity.ScenePose a_(com.trolmastercard.sexmod.entity.ScenePose var1) {
        if (var1 == com.trolmastercard.sexmod.entity.ScenePose.aA) {
