...
public abstract class HumanoidGirlEntity extends GirlEntity {
    public int A = 1;
    public int B;
    public int C = 0;
    public int D;
    ...
    public static final EntityDataAccessor<ItemStack> H = SynchedEntityData.defineId(HumanoidGirlEntity.class, EntityDataSerializers.ITEM_STACK);
    public static final EntityDataAccessor<ItemStack> I = SynchedEntityData.defineId(HumanoidGirlEntity.class, EntityDataSerializers.ITEM_STACK);
    public static final EntityDataAccessor<ItemStack> J = SynchedEntityData.defineId(HumanoidGirlEntity.class, EntityDataSerializers.ITEM_STACK);
    public static final EntityDataAccessor<ItemStack> K = SynchedEntityData.defineId(HumanoidGirlEntity.class, EntityDataSerializers.ITEM_STACK);
    public static final EntityDataAccessor<ItemStack> L = SynchedEntityData.defineId(HumanoidGirlEntity.class, EntityDataSerializers.ITEM_STACK);
    public static final EntityDataAccessor<ItemStack> M = SynchedEntityData.defineId(HumanoidGirlEntity.class, EntityDataSerializers.ITEM_STACK);
    public static final EntityDataAccessor<Integer> N = SynchedEntityData.defineId(HumanoidGirlEntity.class, EntityDataSerializers.INT);

    protected HumanoidGirlEntity(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new com.trolmastercard.sexmod.entity.ai.BodyguardGoal(this));
    }
        ...
        if (this.tickCount % 80 == 0 && this.getHealth() != this.getMaxHealth()) {
            if (this.aw()) {
                ...
                var1.sendParticles(
                    ParticleTypes.HEART,
                    this.getX(),
                    this.getY() + 1.0 + com.trolmastercard.sexmod.util.ModState.a.nextDouble(),
                    this.getZ(),
                    var3,
                    1.0,
                    1.0,
                    1.0,
                    com.trolmastercard.sexmod.util.ModState.a.nextGaussian()
                );
            } else {
                this.heal(1.0F);
            }
    ...
    public static final class a {
        ...
        public static void onLivingHeal(LivingHealEvent var0) {
            if (var0.getEntity() instanceof HumanoidGirlEntity var1 && var1.F) {
                if (var1.getHealth() + var0.getAmount() >= var1.getMaxHealth()) {
                    var1.F = false;
                    var1.c(com.trolmastercard.sexmod.entity.ScenePose.a);
                }
            }
        }
    }
