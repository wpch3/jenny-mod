...
public class KoboldEggEntity extends LivingEntity implements GeoEntity {
    ...
    public UUID a = null;
    public static final EntityDataAccessor<String> b = SynchedEntityData.defineId(KoboldEggEntity.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<Integer> c = SynchedEntityData.defineId(KoboldEggEntity.class, EntityDataSerializers.INT);

    public KoboldEggEntity(EntityType<? extends LivingEntity> var1, Level var2) {
        super(var1, var2);
    }
    ...
    void b() {
        for (int var1 = 0; var1 < 30; var1++) {
            float var2 = (com.trolmastercard.sexmod.util.ModState.a.nextBoolean() ? 1 : -1) * com.trolmastercard.sexmod.util.ModState.a.nextFloat();
            float var3 = (com.trolmastercard.sexmod.util.ModState.a.nextBoolean() ? 1 : -1) * com.trolmastercard.sexmod.util.ModState.a.nextFloat();
            float var4 = (com.trolmastercard.sexmod.util.ModState.a.nextBoolean() ? 1 : -1) * com.trolmastercard.sexmod.util.ModState.a.nextFloat();
        ...
        if (!this.level().isClientSide()) {
            ...
            this.c();
            if (!com.trolmastercard.sexmod.server.TribeData.a(this.a)) {
                com.trolmastercard.sexmod.server.TribeData.a(this.a, com.trolmastercard.sexmod.EyeAndKoboldColor.a((String)this.entityData.get(b)));
            }

            com.trolmastercard.sexmod.entity.KoboldEntity var8 = com.trolmastercard.sexmod.entity.KoboldEntity.a(this.level(), this.a);
            if (var8 != null) {
                com.trolmastercard.sexmod.server.TribeData.b(this.a, var8);
                UUID var9 = com.trolmastercard.sexmod.server.TribeData.o(this.a);
                if (var9 != null) {
                ...
                for (com.trolmastercard.sexmod.entity.KoboldEntity var6 : var10) {
                    String var7 = (String)var6.getEntityData().get(com.trolmastercard.sexmod.entity.KoboldEntity.f);
                    if (!"".equals(var7)) {
                        var11 = var7;
                        break;
                    }
                ...
                if (var11 != null) {
                    var8.getEntityData().set(com.trolmastercard.sexmod.entity.KoboldEntity.f, var11);
                }
    ...
    void a(com.trolmastercard.sexmod.entity.KoboldEntity var1) {
        Player var2 = var1.ay();
        if (var2 != null) {
            com.trolmastercard.sexmod.EyeAndKoboldColor var3 = com.trolmastercard.sexmod.server.TribeData.g(this.a);
    ...
    protected PlayState a(AnimationState<KoboldEggEntity> var1) {
