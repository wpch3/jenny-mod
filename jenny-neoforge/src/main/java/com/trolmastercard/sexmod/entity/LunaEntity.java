...
public class LunaEntity extends HumanoidGirlEntity implements Triggerable {
    public static double a = 0.01;
    public ItemStack b = new ItemStack((ItemLike)com.trolmastercard.sexmod.registry.ModItems.q.get());
    public static final EntityDataAccessor<Float> c = SynchedEntityData.defineId(LunaEntity.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<ItemStack> d = SynchedEntityData.defineId(LunaEntity.class, EntityDataSerializers.ITEM_STACK);
    public static final EntityDataAccessor<Boolean> e = SynchedEntityData.defineId(LunaEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<ItemStack> f = SynchedEntityData.defineId(LunaEntity.class, EntityDataSerializers.ITEM_STACK);
    @Nullable
    public com.trolmastercard.sexmod.entity.LunaHookEntity g;
    public float h = 1.0F;
    public float i = 0.0F;
    int j = 8000;
    ...
    public LunaEntity(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
        this.B = 230;
        this.C = 150;
        this.D = 320;
    ...
    public void i_() {
        ...
        com.trolmastercard.sexmod.registry.ModSounds.a(this, "luna", "owo");
    }

    @Override
    public void c(com.trolmastercard.sexmod.entity.ScenePose var1) {
        com.trolmastercard.sexmod.entity.ScenePose var2 = this.ai();
        if (var2 != com.trolmastercard.sexmod.entity.ScenePose.aH || var1 != com.trolmastercard.sexmod.entity.ScenePose.aF && var1 != com.trolmastercard.sexmod.entity.ScenePose.aG) {
            if (var2 != com.trolmastercard.sexmod.entity.ScenePose.aC || var1 != com.trolmastercard.sexmod.entity.ScenePose.aB && var1 != com.trolmastercard.sexmod.entity.ScenePose.aA) {
                super.c(var1);
            }
        }
    }
    ...
    public boolean a(Player var1) {
        ...
        com.trolmastercard.sexmod.entity.GirlEntity.a(var1, this, var2, var3, false);
        return true;
    }
    ...
    protected void customServerAiStep() {
        ...
        if (this.m) {
            ...
            if (!(var2 < 0.5) && this.n <= 200) {
                ...
                this.c(com.trolmastercard.sexmod.entity.ScenePose.aD);
            }
        }
        ...
        if (this.k) {
            ...
            if (!this.position().equals(this.am()) && this.l <= 40) {
                ...
                Vec3 var5 = com.trolmastercard.sexmod.util.LerpUtils.a(this.position(), this.am(), 40 - this.l);
    ...
    public void tick() {
        super.tick();
        if (com.trolmastercard.sexmod.entity.ScenePose.aD.equals(this.ai())) {
            this.j();
        } else {
            this.o = 0;
        }
        ...
        if (var1 != null) {
            if (!(var1.distanceTo(this) > 1.25F)) {
                if (this.level().isClientSide()) {
                    ...
                    this.c(com.trolmastercard.sexmod.entity.ScenePose.aE);
    ...
    void a(Player var1, int var2) {
        Player var3 = com.trolmastercard.sexmod.client.ClientUtils.b();
        if (var3 != null) {
            ...
            if (var2 == 25 && var3.getUUID().equals(var1.getUUID())) {
                com.trolmastercard.sexmod.client.ClientUtils.e();
            }
        }
    }
            ...
            if (this.u) {
                ...
                if (this.j >= 1200) {
                    if (this.g != null && this.g.a == 15) {
                        ((com.trolmastercard.sexmod.item.LunaRodItem)this.b.getItem()).a(this.level(), this, InteractionHand.MAIN_HAND);
                        this.t = this.level().getGameTime() + 20L;
                        ItemStack var1 = (ItemStack)this.entityData.get(f);
                        if (!var1.isEmpty()) {
                            if (var1.has(DataComponents.FOOD)) {
                                this.c(com.trolmastercard.sexmod.entity.ScenePose.ax);
                            } else {
                                this.c(com.trolmastercard.sexmod.entity.ScenePose.ay);
                            }
                        }
                    }
                    ...
                    if (this.p == null || this.v != null) {
                        ...
                        } else if (this.ai() == com.trolmastercard.sexmod.entity.ScenePose.av && this.g == null) {
                            ((com.trolmastercard.sexmod.item.LunaRodItem)this.b.getItem()).a(this.level(), this, InteractionHand.MAIN_HAND);
    ...
    void q() {
        ...
        if (var1 != null) {
            ...
            if (var2 != null) {
                Node var3 = new Node(
                    com.trolmastercard.sexmod.util.MiscUtils.a(this.getX()), com.trolmastercard.sexmod.util.MiscUtils.a(this.getY()), com.trolmastercard.sexmod.util.MiscUtils.a(this.getZ())
                );
    ...
    protected com.trolmastercard.sexmod.entity.ScenePose a_(com.trolmastercard.sexmod.entity.ScenePose var1) {
        if (var1 == com.trolmastercard.sexmod.entity.ScenePose.az) {
            return com.trolmastercard.sexmod.entity.ScenePose.aA;
        } else if (var1 == com.trolmastercard.sexmod.entity.ScenePose.aE) {
            return com.trolmastercard.sexmod.entity.ScenePose.aF;
        } else if (var1 == com.trolmastercard.sexmod.entity.ScenePose.aA) {
            return com.trolmastercard.sexmod.entity.ScenePose.aB;
        } else {
            return var1 == com.trolmastercard.sexmod.entity.ScenePose.aF ? com.trolmastercard.sexmod.entity.ScenePose.aG : null;
        }
    }

    @Override
    protected com.trolmastercard.sexmod.entity.ScenePose b(com.trolmastercard.sexmod.entity.ScenePose var1) {
        if (var1 == com.trolmastercard.sexmod.entity.ScenePose.aA || var1 == com.trolmastercard.sexmod.entity.ScenePose.aB) {
            return com.trolmastercard.sexmod.entity.ScenePose.aC;
        } else {
            return var1 != com.trolmastercard.sexmod.entity.ScenePose.aG && var1 != com.trolmastercard.sexmod.entity.ScenePose.aF ? null : com.trolmastercard.sexmod.entity.ScenePose.aH;
        }
    }
    ...
    protected void c_() {
        ...
        if ("touch_boobs".equals(var1)) {
            if (this.ai() != com.trolmastercard.sexmod.entity.ScenePose.g) {
        ...
        if (this.level().isClientSide()) {
            ...
            this.entityData.set(com.trolmastercard.sexmod.entity.GirlEntity.av, "");
        }
    }

    protected void playHurtSound(DamageSource var1) {
        com.trolmastercard.sexmod.registry.ModSounds.a(this, "luna", "ouu");
    }

    protected SoundEvent getDeathSound() {
        if (this.getRandom().nextFloat() * 100.0F > 95.0F) {
            DeferredHolder var1 = com.trolmastercard.sexmod.registry.ModSounds.a("girls.allie.scawy.scawy2");
            if (var1 != null) {
                return (SoundEvent)var1.get();
            }
        }

        DeferredHolder var2 = com.trolmastercard.sexmod.registry.ModSounds.a("girls.luna.ouu.ouu12");
