...
public class AllieEntity extends GirlEntity {
    ...
    public boolean a(Player var1) {
        ...
        GirlEntity.a(var1, this, var2, false);
        return true;
    }

    @Override
    protected com.trolmastercard.sexmod.entity.ScenePose a_(com.trolmastercard.sexmod.entity.ScenePose var1) {
        if (var1 == com.trolmastercard.sexmod.entity.ScenePose.ah) {
            return com.trolmastercard.sexmod.entity.ScenePose.ai;
        } else if (var1 == com.trolmastercard.sexmod.entity.ScenePose.bE) {
            return com.trolmastercard.sexmod.entity.ScenePose.bA;
        } else if (var1 == com.trolmastercard.sexmod.entity.ScenePose.bB) {
            return com.trolmastercard.sexmod.entity.ScenePose.bC;
        } else if (var1 == com.trolmastercard.sexmod.entity.ScenePose.ai) {
    ...
    public void c(com.trolmastercard.sexmod.entity.ScenePose var1) {
        ...
        if (var2 != com.trolmastercard.sexmod.entity.ScenePose.ak || var1 != com.trolmastercard.sexmod.entity.ScenePose.aj && var1 != com.trolmastercard.sexmod.entity.ScenePose.ai) {
            if (var2 != com.trolmastercard.sexmod.entity.ScenePose.bD
                ...
                if (!this.level().isClientSide() && var1 == com.trolmastercard.sexmod.entity.ScenePose.bE) {
                    this.g();
                }
    ...
    public void a(String var1, UUID var2) {
        ...
        if ("action.names.makemerichallie".equals(var1)) {
            this.c(this.b() ? com.trolmastercard.sexmod.entity.ScenePose.ap : com.trolmastercard.sexmod.entity.ScenePose.aq);
        } else {
            String var3 = "action.names.deepthroat".equals(var1) ? "deepthroat" : "reverse_cowgirl";
            this.a("animationFollowUp", var3);
            this.c(this.b() ? com.trolmastercard.sexmod.entity.ScenePose.ag : com.trolmastercard.sexmod.entity.ScenePose.al);
        }
    }
