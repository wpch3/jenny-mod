...
public class BodyguardGoal extends Goal {
    private final HumanoidGirlEntity a;
    private Player b;
    ...
    public BodyguardGoal(HumanoidGirlEntity var1) {
        this.a = var1;
