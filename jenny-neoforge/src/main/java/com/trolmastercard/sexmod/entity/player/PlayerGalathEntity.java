...
public class PlayerGalathEntity extends PlayerGirlEntity {
    boolean l = false;
    int m = 0;
    boolean n = false;
    boolean o = false;

    public PlayerGalathEntity(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
    }
    ...
    protected com.trolmastercard.sexmod.entity.ScenePose b(com.trolmastercard.sexmod.entity.ScenePose var1) {
        if (var1 == com.trolmastercard.sexmod.entity.ScenePose.bU || var1 == com.trolmastercard.sexmod.entity.ScenePose.bT) {
            ...
            return var1 == com.trolmastercard.sexmod.entity.ScenePose.bP ? com.trolmastercard.sexmod.entity.ScenePose.bS : null;
        }
    }
    ...
    public void c(com.trolmastercard.sexmod.entity.ScenePose var1) {
        ...
        if (var2 != com.trolmastercard.sexmod.entity.ScenePose.bV || var1 != com.trolmastercard.sexmod.entity.ScenePose.bU && var1 != com.trolmastercard.sexmod.entity.ScenePose.bT) {
            if (var2 != com.trolmastercard.sexmod.entity.ScenePose.bS || var1 != com.trolmastercard.sexmod.entity.ScenePose.bP) {
                if (var2 != com.trolmastercard.sexmod.entity.ScenePose.bS || var1 != com.trolmastercard.sexmod.entity.ScenePose.bR) {
    ...
    public boolean a(Player var1) {
        com.trolmastercard.sexmod.entity.GirlEntity.a(var1, this, new String[]{"cowgirl", "mating press", "ride"}, false);
        return true;
    }
    ...
    void u() {
        if (this.aB()) {
            if (this.ai() == com.trolmastercard.sexmod.entity.ScenePose.bQ) {
                ;
            }
        }
    }
    ...
    void v() {
        ...
        this.l = var1 == com.trolmastercard.sexmod.entity.ScenePose.bV
            || var1 == com.trolmastercard.sexmod.entity.ScenePose.bU
            || var1 == com.trolmastercard.sexmod.entity.ScenePose.bT
            || var1 == com.trolmastercard.sexmod.entity.ScenePose.bQ
            || var1 == com.trolmastercard.sexmod.entity.ScenePose.bP
            || var1 == com.trolmastercard.sexmod.entity.ScenePose.bS
            || var1 == com.trolmastercard.sexmod.entity.ScenePose.bO
            || var1 == com.trolmastercard.sexmod.entity.ScenePose.bR;
    }
