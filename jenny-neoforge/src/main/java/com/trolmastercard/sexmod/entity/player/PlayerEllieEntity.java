...
public class PlayerEllieEntity extends PlayerGirlEntity {
    public PlayerEllieEntity(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
    }
    ...
    public boolean a(Player var1) {
        com.trolmastercard.sexmod.entity.GirlEntity.a(var1, this, new String[]{"Face fuck"}, false);
        return true;
    }
    ...
    protected com.trolmastercard.sexmod.entity.ScenePose a_(com.trolmastercard.sexmod.entity.ScenePose var1) {
        if (var1 == com.trolmastercard.sexmod.entity.ScenePose.x) {
    ...
    protected void customServerAiStep() {
        ...
        if (this.ai() == com.trolmastercard.sexmod.entity.ScenePose.v) {
            String var2 = (String)this.entityData.get(com.trolmastercard.sexmod.entity.GirlEntity.av);
