...
public class LunaHookRenderer extends EntityRenderer<com.trolmastercard.sexmod.entity.LunaHookEntity> {
    ...
    public LunaHookRenderer(Context var1) {
        super(var1);
    }

    @Override
    public void render(com.trolmastercard.sexmod.entity.LunaHookEntity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
        com.trolmastercard.sexmod.entity.LunaEntity var8 = var1.c();
        Vec3 var7;
        if (var8 == null) {
            var7 = Vec3.ZERO;
        } else {
    ...
    @Override
    public boolean shouldRender(com.trolmastercard.sexmod.entity.LunaHookEntity var1, Frustum var2, double var3, double var5, double var7) {
        return var1.shouldRender(var3, var5, var7);
    }

    private static Vec3 a(com.trolmastercard.sexmod.entity.LunaEntity var0, float var1) {
    ...
    @Override
    public ResourceLocation getTextureLocation(com.trolmastercard.sexmod.entity.LunaHookEntity var1) {
        return a;
    }
}
