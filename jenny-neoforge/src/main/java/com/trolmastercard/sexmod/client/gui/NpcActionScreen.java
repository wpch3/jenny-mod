...
public class NpcActionScreen extends Screen {
    private final com.trolmastercard.sexmod.entity.BeeEntity a;
    private final Player b;

    private NpcActionScreen(com.trolmastercard.sexmod.entity.BeeEntity var1, Player var2) {
        super(Component.empty());
        this.a = var1;
        this.b = var2;
    }

    public static void a(com.trolmastercard.sexmod.entity.BeeEntity var0, Player var1) {
        Minecraft var2 = Minecraft.getInstance();
        var2.execute(() -> var2.setScreen(new NpcActionScreen(var0, var1)));
    }
    ...
    protected void init() {
        ...
        boolean var4 = (Boolean)this.a.getEntityData().get(ContainerGirlEntity.d);
    ...
    private void a() {
        if (this.a.aw()) {
            ...
            com.trolmastercard.sexmod.client.ClientUtils.a(Component.translatable("bee.dialogue.sad"));
        } else {
            this.a.a("action.names.followme", this.b);
            com.trolmastercard.sexmod.client.ClientUtils.a(Component.translatable("bee.dialogue.exited"));
        }
    ...
    private void b() {
        ...
        com.trolmastercard.sexmod.client.ClientUtils.a(Component.translatable("bee.dialogue.home"));
        this.onClose();
    }
    ...
    private void d() {
        if ((Boolean)this.a.getEntityData().get(ContainerGirlEntity.d)) {
            com.trolmastercard.sexmod.client.ClientUtils.a(new com.trolmastercard.sexmod.network.OpenBeeChestPayload(this.a.ah().toString()));
            this.onClose();
        }
    }
