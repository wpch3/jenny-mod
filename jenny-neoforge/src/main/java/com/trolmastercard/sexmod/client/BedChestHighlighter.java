...
public final class BedChestHighlighter {
            ...
            if (!a.isEmpty()) {
                ...
                if (var1.player != null && var1.level != null) {
                    boolean var2 = var1.player.getMainHandItem().getItem() instanceof com.trolmastercard.sexmod.item.KoboldStaffItem
                        || var1.player.getOffhandItem().getItem() instanceof com.trolmastercard.sexmod.item.KoboldStaffItem;
                    if (var2) {
