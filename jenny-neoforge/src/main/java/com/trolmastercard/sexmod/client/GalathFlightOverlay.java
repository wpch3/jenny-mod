...
public final class GalathFlightOverlay {
    ...
    public static void onClientTick(Post var0) {
        ...
        boolean var2 = var1.player != null && var1.player.getVehicle() instanceof com.trolmastercard.sexmod.entity.GalathEntity;
        if (var2) {
            c();
    ...
    public static void onRenderGui(net.neoforged.neoforge.client.event.RenderGuiEvent.Post var0) {
        ...
        if (h) {
            ...
            if (var5 - m > 500L) {
                ...
                var7 = com.trolmastercard.sexmod.util.MiscUtils.a(var7, 0.0F, 1.0F);
                a(var1, b, var4 - b[2] / 2, var3 - 70, var7);
                a(var1, e, (int)(var4 - 1.5F * c[2] + 1.0F), var3 - 70 + 3, var7);
                a(var1, e, var4 - c[2] / 2 + 1, var3 - 70 + 3, var7);
                a(var1, e, var4 + c[2] / 2 + 1, var3 - 70 + 3, var7);
                float var8 = (float)com.trolmastercard.sexmod.util.LerpUtils.b(Math.min(1.0F, (float)(var5 - j) / 150.0F));
                float var9 = var8 == 1.0F ? com.trolmastercard.sexmod.util.MiscUtils.a(1.0F - (float)(var5 - k) / 500.0F, 0.0F, 1.0F) : 0.0F;
    ...
    private static void a(GuiGraphics var0, int[] var1, int var2, int var3, float var4) {
        int var5 = (int)(com.trolmastercard.sexmod.util.MiscUtils.a(var4, 0.0F, 1.0F) * 255.0F);
        if (var5 > 0) {
