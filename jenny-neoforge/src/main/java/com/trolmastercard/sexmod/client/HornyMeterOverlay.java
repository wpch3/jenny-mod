...
public final class HornyMeterOverlay {
    ...
    public static void onRenderGui(Post var0) {
        ...
        if (d && var3.player != null) {
            ...
            int var8 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(-200.0F, 98.0F, g);
            var1.blit(b, var8, 405, 0.0F, 0.0F, 158, 54, 256, 256);
            var7.popPose();
            var7.pushPose();
            var7.scale(0.75F, 0.75F, 1.0F);
            int var9 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(-200.0F, 10.0F, g);
            var1.blit(c, 10, var9, 0.0F, 0.0F, 146, 175, 256, 256);
            f = com.trolmastercard.sexmod.util.LerpUtils.a(f, e, var4);
            int var10 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(0.0, 160.0, f);
            int var11 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(167.0, 8.0, f);
            double var12 = com.trolmastercard.sexmod.util.LerpUtils.a(178.0, 18.0, f);
            if (!var5) {
                int var14 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(-45.0, var12, g);
                var1.blit(c, 67, var14, 159.0F, var11, 32, var10, 256, 256);
                double var15 = com.trolmastercard.sexmod.util.LerpUtils.a(178.0, 149.0, 1.0 - f);
                int var17 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(169.0, 141.0, 1.0 - f);
                int var18 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(1.0, 29.0, 1.0 - f);
                int var19 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(-58.0, var15, g);
                var1.blit(c, 120, var19, 212.0F, var17, 28, var18, 256, 256);
                var1.blit(c, 18, var19, 212.0F, var17, 28, var18, 256, 256);
            } else {
                h += var4 / 15.0F;
                int var20 = (int)com.trolmastercard.sexmod.util.LerpUtils.a(18.0F, -300.0F, h);
