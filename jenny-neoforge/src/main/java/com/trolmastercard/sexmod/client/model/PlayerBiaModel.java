...
public class PlayerBiaModel extends GirlModel<com.trolmastercard.sexmod.entity.player.PlayerBiaEntity> {
    public PlayerBiaModel() {
    }
    ...
    // Official cl groups (shared with the NPC model; d stays empty).
    @Override
    public String[] c() {
