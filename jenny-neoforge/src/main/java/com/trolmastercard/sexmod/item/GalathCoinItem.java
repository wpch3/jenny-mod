...
public class GalathCoinItem extends Item implements GeoItem {
    ...
    public static GalathCoinItem a;

    public GalathCoinItem(Properties var1) {
        super(var1);
        a = this;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level var1, Player var2, InteractionHand var3) {
        ...
        if ((var4.contains("sexmod:galath_coin_deactivation_time") ? var4.getLong("sexmod:galath_coin_deactivation_time") : 0L) != 0L) {
            ...
            com.trolmastercard.sexmod.registry.ModSounds.b(var2, "misc.beew.beew0");
            return InteractionResultHolder.success(var2.getItemInHand(var3));
        } else {
            com.trolmastercard.sexmod.registry.ModSounds.b(var2, "misc.weoweo.weoweo1");
    ...
    public static void onEntityInteract(EntityInteract var0) {
        ...
        if (var2.getItem() instanceof GalathCoinItem) {
            if (var0.getTarget() instanceof com.trolmastercard.sexmod.entity.GalathEntity var4) {
                if (var1.getUUID().equals(var4.ax())) {
                    com.trolmastercard.sexmod.registry.ModSounds.b(var1, "misc.weoweo.weoweo0");
    ...
    void a(Player var1, CompoundTag var2, long var3, long var5) {
        if (var5 != 0L) {
            if (var3 - var5 > 4000L) {
                ...
                com.trolmastercard.sexmod.entity.GalathEntity var18 = com.trolmastercard.sexmod.entity.GalathEntity.a(var1.level(), var1, var8, false);
                if (var18 != null) {
                    var18.moveTo(var8.x, var8.y, var8.z, var18.getYRot(), var18.getXRot());
                    com.trolmastercard.sexmod.server.PlayerModData.a(var1, var18);
                    var1.level().addFreshEntity(var18);
                    if (com.trolmastercard.sexmod.server.PlayerModData.a(var1.getUUID())) {
                        var18.l();
                    }
                }
            }
    ...
    void b(Player var1, CompoundTag var2, long var3, long var5) {
        if (var5 != 0L) {
            ...
            if (var3 - var5 > 3000L) {
                UUID var10 = com.trolmastercard.sexmod.server.PlayerModData.a(var1);
                GirlEntity var11 = GirlEntity.t(var10);
                if (var11 instanceof com.trolmastercard.sexmod.entity.GalathEntity) {
                    com.trolmastercard.sexmod.server.PlayerModData.b((com.trolmastercard.sexmod.entity.GalathEntity)var11);
                }
            }
        }
    }
    ...
    void b(Player var1) {
        UUID var2 = com.trolmastercard.sexmod.server.PlayerModData.a(var1);
        if (GirlEntity.t(var2) instanceof com.trolmastercard.sexmod.entity.GalathEntity var4) {
            a(var4);
    ...
    public static void a(com.trolmastercard.sexmod.entity.GalathEntity var0) {
        var0.c(ScenePose.ca);
        var0.k();
        var0.d(true);
    ...
    public static void onPlayerChangedDimension(PlayerChangedDimensionEvent var0) {
        ...
        if (!var1.level().isClientSide()) {
            UUID var2 = com.trolmastercard.sexmod.server.PlayerModData.a(var1);
            GirlEntity var3 = GirlEntity.t(var2);
            if (var3 != null) {
                com.trolmastercard.sexmod.server.PlayerModData.b((com.trolmastercard.sexmod.entity.GalathEntity)var3);
            }
        }
    }
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> var1) {
        var1.accept(new GeoRenderProvider() {
            private GeoItemRenderer<GalathCoinItem> a;

            @Override
            public GeoItemRenderer<?> getGeoItemRenderer() {
                if (this.a == null) {
                    this.a = new GalathCoinRenderer();
                }
