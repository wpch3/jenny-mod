...
public class LunaRodItem extends FishingRodItem {
    public LunaRodItem(Properties var1) {
        super(var1);
    }

    public void a(Level var1, LunaEntity var2, InteractionHand var3) {
        ...
        if (var2.g != null) {
            ...
            if (!var1.isClientSide()) {
                ...
                com.trolmastercard.sexmod.entity.LunaHookEntity var7 = new com.trolmastercard.sexmod.entity.LunaHookEntity(
                    (EntityType<? extends Entity>)com.trolmastercard.sexmod.registry.ModEntities.z.get(), var1, var2, var10 * LunaEntity.a
                );
