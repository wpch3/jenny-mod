...
public class KoboldStaffItem extends Item implements GeoItem {
    ...
    public KoboldStaffItem(Properties var1) {
        super(var1);
    }
    ...
    public static void onRightClickItem(RightClickItem var0) {
        ...
        if (var1.getMainHandItem().getItem() instanceof KoboldStaffItem || var1.getOffhandItem().getItem() instanceof KoboldStaffItem) {
            if (var1.level().isClientSide()) {
                com.trolmastercard.sexmod.client.ClientUtils.g();
            }
        }
    }
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> var1) {
        var1.accept(new GeoRenderProvider() {
            private GeoItemRenderer<KoboldStaffItem> a;

            @Override
            public GeoItemRenderer<?> getGeoItemRenderer() {
                if (this.a == null) {
                    this.a = new com.trolmastercard.sexmod.client.renderer.KoboldStaffRenderer();
                }
