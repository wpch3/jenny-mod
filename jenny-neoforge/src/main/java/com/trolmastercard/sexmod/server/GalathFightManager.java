...
public final class GalathFightManager {
                ...
                if (var2 != null) {
                    switch (b) {
                        case 0:
                            ...
                            var2.getChunk(0, 0);
                            Sexmod.a.info("[GAMEPLAY] force-loaded + ticketed chunk (0,0); settling before spawn");
                            b = 1;
                            c = 0;
                            return;
                        case 1:
                        ...
                        case 2:
                            ...
                            com.trolmastercard.sexmod.entity.GalathEntity var15 = (com.trolmastercard.sexmod.entity.GalathEntity)((EntityType)com.trolmastercard.sexmod.registry.ModEntities.t.get())
                                .create(var2);
                            ...
                            return;
                        case 3:
                            if (var2.getEntity(d) instanceof com.trolmastercard.sexmod.entity.GalathEntity var3 && var3.isAlive()) {
                                ...
                                int var14 = var2.getEntitiesOfClass(
                                        com.trolmastercard.sexmod.entity.EnergyBallEntity.class, new AABB(var3.position(), var3.position()).inflate(48.0)
                                    )
                                    .size();
                                if (var14 > h) {
                                    h = var14;
    ...
    private static void a(ServerLevel var0, String var1) {
        Sexmod.a.info("[GAMEPLAY] GALATH_FIGHT DONE \u2014 " + var1);
        ...
        try {
            ...
            Sexmod.a.info("[GAMEPLAY] could not write gameplay.done: " + var3);
        }
