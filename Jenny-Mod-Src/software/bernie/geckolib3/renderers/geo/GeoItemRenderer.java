...
public abstract class GeoItemRenderer<T extends Item & IAnimatable> extends TileEntityItemStackRenderer implements IGeoRenderer<T> {
   ...
   public void func_192838_a(ItemStack itemStack, float partialTicks) {
      this.render((T)itemStack.func_77973_b(), itemStack);
   }
   ...
   public void render(T animatable, ItemStack itemStack) {
      ...
      AnimationEvent itemEvent = new AnimationEvent(
         animatable, 0.0F, 0.0F, Minecraft.func_71410_x().func_184121_ak(), false, Collections.singletonList(itemStack)
      );
   ...
   public Integer getUniqueID(T animatable) {
      return Objects.hash(
         this.currentItemStack.func_77973_b(),
         this.currentItemStack.func_190916_E(),
         this.currentItemStack.func_77942_o() ? this.currentItemStack.func_77978_p().toString() : 1
      );
   }
