...
public class MathBuilder {
   ...
   public String[] breakdown(String expression) throws Exception {
      ...
      if (left != right) {
         throw new Exception(
            "Given expression '" + expression + "' has more uneven amount of parenthesis, there are " + left + " open and " + right + " closed!"
         );
      } else {
         return chars;
      }
   ...
   protected IValue tryTernary(List<Object> symbols) throws Exception {
      ...
      return questions == colons && question > 0 && question + 1 < colon && colon < size - 1
         ? new Ternary(
