...
public @interface JsonAutoDetect {
   ...
   class Value implements JacksonAnnotationValue<JsonAutoDetect>, Serializable {
      private static final long serialVersionUID = 1L;
      private static final JsonAutoDetect.Visibility DEFAULT_FIELD_VISIBILITY = JsonAutoDetect.Visibility.PUBLIC_ONLY;
      protected static final JsonAutoDetect.Value DEFAULT = new JsonAutoDetect.Value(
      ...
      protected static final JsonAutoDetect.Value NO_OVERRIDES = new JsonAutoDetect.Value(
      ...
      protected Object readResolve() {
         JsonAutoDetect.Value v = _predefined(
            this._fieldVisibility, this._getterVisibility, this._isGetterVisibility, this._setterVisibility, this._creatorVisibility
         );
      ...
      public String toString() {
         return String.format(
            ...
            this._getterVisibility,
            this._isGetterVisibility,
            this._setterVisibility,
            this._creatorVisibility
         );
      }

      @Override
      public int hashCode() {
         return 1 + this._fieldVisibility.ordinal()
            ^ 3 * this._getterVisibility.ordinal() - 7 * this._isGetterVisibility.ordinal() + 11 * this._setterVisibility.ordinal()
            ^ 13 * this._creatorVisibility.ordinal();
      }
      ...
      public boolean equals(Object o) {
         if (o == this) {
            ...
            return o == null ? false : o.getClass() == this.getClass() && _equals(this, (JsonAutoDetect.Value)o);
         }
      }

      private static JsonAutoDetect.Value _predefined(
         JsonAutoDetect.Visibility fields,
         JsonAutoDetect.Visibility getters,
         JsonAutoDetect.Visibility isGetters,
         JsonAutoDetect.Visibility setters,
         ...
         if (fields == DEFAULT_FIELD_VISIBILITY) {
            ...
            && getters == JsonAutoDetect.Visibility.DEFAULT
            && isGetters == JsonAutoDetect.Visibility.DEFAULT
            && setters == JsonAutoDetect.Visibility.DEFAULT
            && creators == JsonAutoDetect.Visibility.DEFAULT) {
            return NO_OVERRIDES;
         }
