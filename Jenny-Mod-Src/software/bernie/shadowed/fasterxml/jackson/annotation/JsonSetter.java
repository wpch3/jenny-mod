...
public @interface JsonSetter {
   ...
   class Value implements JacksonAnnotationValue<JsonSetter>, Serializable {
      private static final long serialVersionUID = 1L;
      private final Nulls _nulls;
      private final Nulls _contentNulls;
      protected static final JsonSetter.Value EMPTY = new JsonSetter.Value(Nulls.DEFAULT, Nulls.DEFAULT);
      ...
      public static JsonSetter.Value construct(Nulls nulls, Nulls contentNulls) {
         ...
         return _empty(nulls, contentNulls) ? EMPTY : new JsonSetter.Value(nulls, contentNulls);
      }
      ...
      public boolean equals(Object o) {
         ...
         JsonSetter.Value other = (JsonSetter.Value)o;
