...
public @interface JsonInclude {
   ...
   class Value implements JacksonAnnotationValue<JsonInclude>, Serializable {
      private static final long serialVersionUID = 1L;
      protected static final JsonInclude.Value EMPTY = new JsonInclude.Value(JsonInclude.Include.USE_DEFAULTS, JsonInclude.Include.USE_DEFAULTS, null, null);
      ...
      public static JsonInclude.Value mergeAll(JsonInclude.Value... values) {
         ...
         for (JsonInclude.Value curr : values) {
            if (curr != null) {
      ...
      protected Object readResolve() {
         return this._valueInclusion == JsonInclude.Include.USE_DEFAULTS
               && this._contentInclusion == JsonInclude.Include.USE_DEFAULTS
      ...
      public static JsonInclude.Value construct(JsonInclude.Include valueIncl, JsonInclude.Include contentIncl) {
         return valueIncl != JsonInclude.Include.USE_DEFAULTS && valueIncl != null || contentIncl != JsonInclude.Include.USE_DEFAULTS && contentIncl != null
            ? new JsonInclude.Value(valueIncl, contentIncl, null, null)
            : EMPTY;
      }
      ...
      public static JsonInclude.Value construct(JsonInclude.Include valueIncl, JsonInclude.Include contentIncl, Class<?> valueFilter, Class<?> contentFilter) {
         ...
         return (valueIncl == JsonInclude.Include.USE_DEFAULTS || valueIncl == null)
               && (contentIncl == JsonInclude.Include.USE_DEFAULTS || contentIncl == null)
               && valueFilter == null
               && contentFilter == null
            ? EMPTY
            : new JsonInclude.Value(valueIncl, contentIncl, valueFilter, contentFilter);
      }
      ...
      public boolean equals(Object o) {
         ...
         return other._valueInclusion == this._valueInclusion
            && other._contentInclusion == this._contentInclusion
            && other._valueFilter == this._valueFilter
            && other._contentFilter == this._contentFilter;
      }
   }
}
