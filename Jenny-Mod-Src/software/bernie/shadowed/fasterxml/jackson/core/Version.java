...
public class Version implements Comparable<Version>, Serializable {
   ...
   public boolean equals(Object o) {
      ...
      return other._majorVersion == this._majorVersion
         && other._minorVersion == this._minorVersion
         && other._patchLevel == this._patchLevel
         && other._artifactId.equals(this._artifactId)
         && other._groupId.equals(this._groupId);
   }
