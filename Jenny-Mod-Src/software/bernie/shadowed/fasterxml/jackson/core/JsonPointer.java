...
public class JsonPointer {
   ...
   protected JsonPointer _constructHead() {
      ...
      return new JsonPointer(
         this._asString.substring(0, this._asString.length() - suffixLength),
         this._matchingPropertyName,
         this._matchingElementIndex,
   ...
   protected JsonPointer _constructHead(int suffixLength, JsonPointer last) {
      ...
      return new JsonPointer(
         str.substring(0, str.length() - suffixLength), this._matchingPropertyName, this._matchingElementIndex, next._constructHead(suffixLength, last)
      );
   }
