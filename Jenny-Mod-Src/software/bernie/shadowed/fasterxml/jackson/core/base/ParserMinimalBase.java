...
public abstract class ParserMinimalBase extends JsonParser {
   ...
   protected static final double MIN_LONG_D = -9.223372E18F;
   protected static final double MAX_LONG_D = 9.223372E18F;
   protected static final double MIN_INT_D = -2.1474836E9F;
   ...
   public String getValueAsString() throws IOException {
      if (this._currToken == JsonToken.VALUE_STRING) {
         ...
         return this._currToken == JsonToken.FIELD_NAME ? this.getCurrentName() : this.getValueAsString(null);
      }
   }
