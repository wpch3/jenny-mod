...
public abstract class ParserBase extends ParserMinimalBase {
   ...
   public JsonParser enable(JsonParser.Feature f) {
      this._features = this._features | f.getMask();
   ...
   protected void _handleEOF() throws JsonParseException {
      if (!this._parsingContext.inRoot()) {
         ...
         this._reportInvalidEOF(
            String.format(": expected close marker for %s (start marker at %s)", marker, this._parsingContext.getStartLocation(this._getSourceReference())),
            null
         );
      }
   }
   ...
   protected void convertNumberToInt() throws IOException {
      if ((this._numTypesValid & 2) != 0) {
         ...
         if (this._numberDouble < -2.1474836E9F || this._numberDouble > 2.147483647E9) {
            this.reportOverflowInt();
         }
   ...
   protected void _reportMismatchedEndMarker(int actCh, char expCh) throws JsonParseException {
      ...
      this._reportError(
         String.format(
            ...
            expCh,
            ctxt.typeDesc(),
            ctxt.getStartLocation(this._getSourceReference())
         )
      );
   }
