...
public abstract class GeneratorBase extends JsonGenerator {
   ...
   protected static final int DERIVED_FEATURES_MASK = JsonGenerator.Feature.WRITE_NUMBERS_AS_STRINGS.getMask()
   ...
   public JsonGenerator useDefaultPrettyPrinter() {
      return this.getPrettyPrinter() != null ? this : this.setPrettyPrinter(this._constructDefaultPrettyPrinter());
   }
