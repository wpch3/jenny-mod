...
public final class CharsToNameCanonicalizer {
   ...
   private void mergeChild(CharsToNameCanonicalizer.TableInfo childState) {
      ...
      CharsToNameCanonicalizer.TableInfo currState = this._tableInfo.get();
   ...
   public int collisionCount() {
      ...
      for (CharsToNameCanonicalizer.Bucket bucket : this._buckets) {
         if (bucket != null) {
            count += bucket.length;
         }
      }
   ...
   private void _handleSpillOverflow(int bindex, CharsToNameCanonicalizer.Bucket newBucket) {
      ...
      this._size = this._size - newBucket.length;
