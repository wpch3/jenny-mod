...
public class UTF8StreamJsonParser extends ParserBase {
   ...
   protected final boolean _loadMore() throws IOException {
      ...
      this._currInputProcessed = this._currInputProcessed + this._inputEnd;
   ...
   public String getValueAsString() throws IOException {
      if (this._currToken == JsonToken.VALUE_STRING) {
         ...
         return this._currToken == JsonToken.FIELD_NAME ? this.getCurrentName() : super.getValueAsString(null);
      }
   }
      ...
      while (true) {
         ...
         if (ch > 32) {
            ...
            if (bits < 0) {
               ...
               bits = this._decodeBase64Escape(b64variant, (int)ch, 0);
               if (bits < 0) {
                  continue;
               }
            }
            ...
            if (bits < 0) {
               bits = this._decodeBase64Escape(b64variant, (int)ch, 1);
            }
            ...
            if (bits < 0) {
               if (bits != -2) {
                  ...
                  bits = this._decodeBase64Escape(b64variant, (int)ch, 2);
               }
            ...
            if (bits < 0) {
               if (bits != -2) {
                  ...
                  bits = this._decodeBase64Escape(b64variant, (int)ch, 3);
               }
   ...
   private final int _skipColonFast(int ptr) throws IOException {
      ...
      if (i == 58) {
         int var8 = this._inputBuffer[ptr++];
         if (var8 > 32) {
            if (var8 != 47 && var8 != 35) {
               this._inputPtr = ptr;
               return var8;
            }
         } else if (var8 == 32 || var8 == 9) {
            var8 = this._inputBuffer[ptr++];
            if (var8 > 32 && var8 != 47 && var8 != 35) {
               this._inputPtr = ptr;
               return var8;
            }
         }
         ...
         int var6 = this._inputBuffer[ptr++];
         if (var6 > 32) {
            if (var6 != 47 && var6 != 35) {
               this._inputPtr = ptr;
               return var6;
            }
         } else if (var6 == 32 || var6 == 9) {
            var6 = this._inputBuffer[ptr++];
            if (var6 > 32 && var6 != 47 && var6 != 35) {
               this._inputPtr = ptr;
               return var6;
            }
         }
   ...
   private final int _skipColon() throws IOException {
      ...
      if (i == 58) {
         int var4 = this._inputBuffer[++this._inputPtr];
         if (var4 > 32) {
            if (var4 != 47 && var4 != 35) {
               this._inputPtr++;
               return var4;
            ...
            if (var4 == 32 || var4 == 9) {
               var4 = this._inputBuffer[++this._inputPtr];
               if (var4 > 32) {
                  if (var4 != 47 && var4 != 35) {
                     this._inputPtr++;
                     return var4;
         ...
         if (i == 58) {
            int var2 = this._inputBuffer[++this._inputPtr];
            if (var2 > 32) {
               if (var2 != 47 && var2 != 35) {
                  this._inputPtr++;
                  return var2;
   ...
   private final int _decodeUtf8_3(int c1) throws IOException {
      ...
      int var5 = this._inputBuffer[this._inputPtr++];
      if ((var5 & 192) != 128) {
   ...
   private final int _decodeUtf8_4(int c) throws IOException {
      ...
      var5 = this._inputBuffer[this._inputPtr++];
      if ((var5 & 192) != 128) {
         this._reportInvalidOther(var5 & 255, this._inputPtr);
      }

      return (c << 6 | var5 & 63) - 65536;
   }
   ...
   private final void _skipUtf8_4(int c) throws IOException {
      ...
      int var3 = this._inputBuffer[this._inputPtr++];
      if ((var3 & 192) != 128) {
