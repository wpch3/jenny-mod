...
public class ReaderBasedJsonParser extends ParserBase {
   ...
   public ReaderBasedJsonParser(
      IOContext ctxt, int features, Reader r, ObjectCodec codec, CharsToNameCanonicalizer st, char[] inputBuffer, int start, int end, boolean bufferRecyclable
   ) {
      super(ctxt, features);
      this._reader = r;
   ...
   protected final JsonToken _parsePosNumber(int ch) throws IOException {
      ...
      for (int intLen = 1; ptr < inputLen; intLen++) {
         int var7 = this._inputBuffer[ptr++];
         if (var7 < '0' || var7 > '9') {
            if (var7 != '.' && var7 != 'e' && var7 != 'E') {
               ...
               this._inputPtr = ptr;
               return this._parseFloat(var7, startPtr, ptr, false, intLen);
            }
         }
      }
   ...
   protected final JsonToken _parseNegNumber() throws IOException {
      ...
      for (int intLen = 1; ptr < inputLen; intLen++) {
         int var9 = this._inputBuffer[ptr++];
         if (var9 < '0' || var9 > '9') {
            if (var9 != '.' && var9 != 'e' && var9 != 'E') {
               this._inputPtr = --ptr;
               if (this._parsingContext.inRoot()) {
                  this._verifyRootSpace(var9);
               }
               ...
               this._inputPtr = ptr;
               return this._parseFloat(var9, startPtr, ptr, true, intLen);
            }
         }
      }
   ...
   private final JsonToken _parseNumber2(boolean neg, int startPtr) throws IOException {
      ...
      int intLen = 0;
      char c = this._inputPtr < this._inputEnd
         ? this._inputBuffer[this._inputPtr++]
         : this.getNextChar("No digit following minus sign", JsonToken.VALUE_NUMBER_INT);
      if (c == '0') {
