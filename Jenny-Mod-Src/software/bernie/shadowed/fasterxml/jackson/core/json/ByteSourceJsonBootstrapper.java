...
public final class ByteSourceJsonBootstrapper {
   ...
   public JsonEncoding detectEncoding() throws IOException {
      ...
      if (this.ensureLoaded(4)) {
         int quad = this._inputBuffer[this._inputPtr] << 24
            | (this._inputBuffer[this._inputPtr + 1] & 255) << 16
            | (this._inputBuffer[this._inputPtr + 2] & 255) << 8
            | this._inputBuffer[this._inputPtr + 3] & 255;
   ...
   public JsonParser constructParser(
      ...
      if (enc == JsonEncoding.UTF8 && JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(factoryFeatures)) {
         ...
         return new UTF8StreamJsonParser(
            this._context, parserFeatures, this._in, codec, can, this._inputBuffer, this._inputPtr, this._inputEnd, this._bufferRecyclable
         );
      } else {
