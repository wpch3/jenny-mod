...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
   ...
   protected Object _deserializeUsingPropertyBased(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      List<BeanDeserializer.BeanReferring> referrings = null;
            ...
            if (creatorProp != null) {
               ...
               if (prop != null) {
                  try {
                     ...
                     BeanDeserializer.BeanReferring referring = this.handleUnresolvedReference(ctxt, prop, buffer, reference);
                     if (referrings == null) {
   ...
   protected Object deserializeUsingPropertyBasedWithExternalTypeId(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      while (true) {
         ...
         if (creatorProp != null) {
            ...
            bean = this._beanProperties.find(propName);
            if (bean != null) {
               buffer.bufferProperty((SettableBeanProperty)bean, ((SettableBeanProperty)bean).deserialize(p, ctxt));
      ...
      return bean.getClass() != this._beanType.getRawClass()
         ? ctxt.reportBadDefinition(
            this._beanType, String.format("Cannot create polymorphic instances with external type ids (%s -> %s)", this._beanType, bean.getClass())
         )
