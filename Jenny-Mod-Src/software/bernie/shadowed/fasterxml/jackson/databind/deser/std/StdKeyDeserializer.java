...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
   ...
   public Object deserializeKey(String key, DeserializationContext ctxt) throws IOException {
      ...
      return this._keyClass.isEnum() && ctxt.getConfig().isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)
         ? null
   ...
   static final class EnumKD extends StdKeyDeserializer {
      ...
      public Object _parse(String key, DeserializationContext ctxt) throws IOException {
         ...
         return e == null && !ctxt.getConfig().isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)
            ? ctxt.handleWeirdKey(this._keyClass, key, "not one of values excepted for Enum class: %s", res.getEnumIds())
            : e;
      }
