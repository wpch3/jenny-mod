...
public class ReferenceType extends SimpleType {
   ...
   public JavaType withContentType(JavaType contentType) {
      return this._referencedType == contentType
         ? this
         : new ReferenceType(
            this._class,
            this._bindings,
   ...
   public ReferenceType withTypeHandler(Object h) {
      return h == this._typeHandler
         ? this
         : new ReferenceType(
            this._class, this._bindings, this._superClass, this._superInterfaces, this._referencedType, this._anchorType, this._valueHandler, h, this._asStatic
         );
   }

   public ReferenceType withContentTypeHandler(Object h) {
      return h == this._referencedType.getTypeHandler()
         ? this
         : new ReferenceType(
            this._class,
            this._bindings,
            this._superClass,
            this._superInterfaces,
            this._referencedType.withTypeHandler(h),
            this._anchorType,
            this._valueHandler,
            this._typeHandler,
            this._asStatic
   ...
   public ReferenceType withValueHandler(Object h) {
      return h == this._valueHandler
         ? this
         : new ReferenceType(
            this._class, this._bindings, this._superClass, this._superInterfaces, this._referencedType, this._anchorType, h, this._typeHandler, this._asStatic
         );
   }
   ...
   public ReferenceType withStaticTyping() {
      return this._asStatic
         ...
         : new ReferenceType(
            ...
            this._superClass,
            this._superInterfaces,
            this._referencedType.withStaticTyping(),
            this._anchorType,
            this._valueHandler,
            this._typeHandler,
            true
   ...
   public JavaType refine(Class<?> rawType, TypeBindings bindings, JavaType superClass, JavaType[] superInterfaces) {
      return new ReferenceType(
         rawType, this._bindings, superClass, superInterfaces, this._referencedType, this._anchorType, this._valueHandler, this._typeHandler, this._asStatic
      );
   }
   ...
   public String toString() {
      return new StringBuilder(40)
         ...
         .append(this.buildCanonicalName())
         .append('<')
