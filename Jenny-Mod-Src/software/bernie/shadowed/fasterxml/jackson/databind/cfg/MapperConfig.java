...
public abstract class MapperConfig<T extends MapperConfig<T>> implements ClassIntrospector.MixInResolver, Serializable {
   ...
   public AnnotationIntrospector getAnnotationIntrospector() {
      return this.isEnabled(MapperFeature.USE_ANNOTATIONS) ? this._base.getAnnotationIntrospector() : NopAnnotationIntrospector.instance;
   }
   ...
   public JsonInclude.Value getDefaultInclusion(Class<?> baseType, Class<?> propertyType, JsonInclude.Value defaultIncl) {
      ...
      return JsonInclude.Value.mergeAll(defaultIncl, baseOverride, propOverride);
   }
   ...
   public TypeResolverBuilder<?> typeResolverBuilderInstance(Annotated annotated, Class<? extends TypeResolverBuilder<?>> builderClass) {
      ...
      return ClassUtil.createInstance((Class<TypeResolverBuilder<?>>)builderClass, this.canOverrideAccessModifiers());
   }
