...
public class TypeKey {
   ...
   public final String toString() {
      return this._class != null
         ? "{class: " + this._class.getName() + ", typed? " + this._isTyped + "}"
         : "{type: " + this._type + ", typed? " + this._isTyped + "}";
   }
   ...
   public final boolean equals(Object o) {
      if (o == null) {
         ...
         if (other._isTyped == this._isTyped) {
            return this._class != null ? other._class == this._class : this._type.equals(other._type);
         } else {
            return false;
         }
      }
