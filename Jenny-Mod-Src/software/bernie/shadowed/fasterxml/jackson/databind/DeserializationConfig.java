...
public final class DeserializationConfig extends MapperConfigBase<DeserializationFeature, DeserializationConfig> implements Serializable {
   ...
   private DeserializationConfig(
      DeserializationConfig src, int mapperFeatures, int deserFeatures, int parserFeatures, int parserFeatureMask, int formatFeatures, int formatFeatureMask
   ) {
   ...
   protected final DeserializationConfig _withMapperFeatures(int mapperFeatures) {
      return new DeserializationConfig(
         ...
         this._parserFeaturesToChange,
         this._formatReadFeatures,
         this._formatReadFeaturesToChange
      );
   }
   ...
   public DeserializationConfig with(DeserializationFeature feature) {
      ...
      return newDeserFeatures == this._deserFeatures
         ? this
   ...
   public DeserializationConfig with(JsonParser.Feature feature) {
      ...
      return this._parserFeatures == newSet && this._parserFeaturesToChange == newMask
         ? this
         : new DeserializationConfig(
            this, this._mapperFeatures, this._deserFeatures, newSet, newMask, this._formatReadFeatures, this._formatReadFeaturesToChange
         );
   }
   ...
   public DeserializationConfig with(FormatFeature feature) {
      ...
      return this._formatReadFeatures == newSet && this._formatReadFeaturesToChange == newMask
         ? this
         : new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, newSet, newMask);
   }
   ...
   public boolean useRootWrapping() {
      return this._rootName != null ? !this._rootName.isEmpty() : this.isEnabled(DeserializationFeature.UNWRAP_ROOT_VALUE);
   }
   ...
   public final boolean isEnabled(JsonParser.Feature f, JsonFactory factory) {
      int mask = f.getMask();
      return (this._parserFeaturesToChange & mask) != 0 ? (this._parserFeatures & f.getMask()) != 0 : factory.isEnabled(f);
   }
