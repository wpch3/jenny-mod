...
public class PropertyName implements Serializable {
   ...
   public static PropertyName construct(String simpleName) {
      return simpleName != null && simpleName.length() != 0 ? new PropertyName(InternCache.instance.intern(simpleName), null) : USE_DEFAULT;
   }
   ...
   public boolean equals(Object o) {
      ...
      return this._namespace == null ? null == other._namespace : this._namespace.equals(other._namespace);
   }
