...
public abstract class SerializerProvider extends DatabindContext {
   ...
   public static final JsonSerializer<Object> DEFAULT_NULL_KEY_SERIALIZER = new FailingSerializer(
      ...
      if (ser == null) {
         ...
         if (ser == null) {
            ...
            if (ser == null) {
               ...
               if (ser == null) {
                  return this.getUnknownTypeSerializer(valueType);
               }
            }
         }
      }
   ...
   public JsonSerializer<Object> findValueSerializer(JavaType valueType, BeanProperty property) throws JsonMappingException {
      ...
      if (ser == null) {
         ...
         if (ser == null) {
            ser = this._createAndCacheUntypedSerializer(valueType);
            if (ser == null) {
               return this.getUnknownTypeSerializer(valueType.getRawClass());
            }
         }
      }
   ...
   public JsonSerializer<Object> getUnknownTypeSerializer(Class<?> unknownType) {
      return unknownType == Object.class ? this._unknownTypeSerializer : new UnknownSerializer(unknownType);
   }

   public boolean isUnknownTypeSerializer(JsonSerializer<?> ser) {
      return ser != this._unknownTypeSerializer && ser != null
         ? this.isEnabled(SerializationFeature.FAIL_ON_EMPTY_BEANS) && ser.getClass() == UnknownSerializer.class
         : true;
   }
   ...
   protected JsonSerializer<Object> _createAndCacheUntypedSerializer(Class<?> rawType) throws JsonMappingException {
      ...
      try {
         ...
         ser = null;
         this.reportMappingProblem(iae, iae.getMessage());
      }
