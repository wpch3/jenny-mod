...
public final class AnnotatedClass extends Annotated implements TypeResolutionContext {
   private static final AnnotatedClass.Creators NO_CREATORS = new AnnotatedClass.Creators(null, Collections.emptyList(), Collections.emptyList());
   ...
   private final AnnotatedMethodMap _methods() {
      ...
      if (m == null) {
         if (this._type == null) {
            ...
            m = AnnotatedMethodCollector.collectMethods(
               this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, this._type, this._superTypes, this._primaryMixIn
            );
         }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         return !ClassUtil.hasClass(o, this.getClass()) ? false : ((AnnotatedClass)o)._class == this._class;
      }
   }
