...
public class StdDelegatingSerializer extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
   ...
   public boolean isEmpty(SerializerProvider prov, Object value) {
      ...
      if (delegateValue == null) {
         ...
         return this._delegateSerializer == null ? value == null : this._delegateSerializer.isEmpty(prov, delegateValue);
      }
   }

   @Override
   public JsonNode getSchema(SerializerProvider provider, Type typeHint) throws JsonMappingException {
      return this._delegateSerializer instanceof SchemaAware
         ? ((SchemaAware)this._delegateSerializer).getSchema(provider, typeHint)
         : super.getSchema(provider, typeHint);
   }

   @Override
   public JsonNode getSchema(SerializerProvider provider, Type typeHint, boolean isOptional) throws JsonMappingException {
      return this._delegateSerializer instanceof SchemaAware
         ? ((SchemaAware)this._delegateSerializer).getSchema(provider, typeHint, isOptional)
         : super.getSchema(provider, typeHint);
   }
