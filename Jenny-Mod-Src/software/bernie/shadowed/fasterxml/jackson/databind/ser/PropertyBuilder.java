...
public class PropertyBuilder {
   ...
   public PropertyBuilder(SerializationConfig config, BeanDescription beanDesc) {
      ...
      JsonInclude.Value inclPerType = JsonInclude.Value.merge(
         beanDesc.findPropertyInclusion(JsonInclude.Value.empty()), config.getDefaultPropertyInclusion(beanDesc.getBeanClass(), JsonInclude.Value.empty())
      );
   ...
   protected BeanPropertyWriter buildWriter(
      ...
      try {
         ...
         return prov.reportBadPropertyDefinition(this._beanDesc, propDef, e.getMessage());
      }
      ...
      if (accessor == null) {
         return prov.reportBadPropertyDefinition(this._beanDesc, propDef, "could not determine property type");
      }
      ...
      BeanPropertyWriter bpw = new BeanPropertyWriter(
         propDef, am, this._beanDesc.getClassAnnotations(), declaredType, ser, typeSer, serializationType, suppressNulls, valueToSuppress, views
      );
