...
public class MapEntrySerializer extends ContainerSerializer<Entry<?, ?>> implements ContextualSerializer {
   ...
   protected MapEntrySerializer(
      MapEntrySerializer src,
   ...
   public MapEntrySerializer withResolved(
      BeanProperty property, JsonSerializer<?> keySerializer, JsonSerializer<?> valueSerializer, Object suppressableValue, boolean suppressNulls
   ) {
   ...
   public MapEntrySerializer withContentInclusion(Object suppressableValue, boolean suppressNulls) {
      return this._suppressableValue == suppressableValue && this._suppressNulls == suppressNulls
         ? this
         : new MapEntrySerializer(this, this._property, this._valueTypeSerializer, this._keySerializer, this._valueSerializer, suppressableValue, suppressNulls);
   }
