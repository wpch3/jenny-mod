...
public abstract class PropertySerializerMap {
   ...
   private static final class Multi extends PropertySerializerMap {
      ...
      public PropertySerializerMap newWith(Class<?> type, JsonSerializer<Object> serializer) {
         ...
         if (len == 8) {
            return this._resetWhenFull ? new PropertySerializerMap.Single(this, type, serializer) : this;
         }

         PropertySerializerMap.TypeAndSerializer[] entries = Arrays.copyOf(this._entries, len + 1);
