...
public class FertilizerTileEntity extends TileEntity implements IAnimatable {
   ...
   private <E extends TileEntity & IAnimatable> PlayState predicate(AnimationEvent<E> event) {
      ...
      if (event.getAnimatable().func_145831_w().func_72896_J()) {
         event.getController()
            .setAnimation(new AnimationBuilder().addAnimation("fertilizer.animation.deploy", true).addAnimation("fertilizer.animation.idle", true));
      } else {
