...
public class CommonListener {
      ...
      event.getRegistry()
         .register(
            EntityEntryBuilder.create()
               ...
               .name("Bike")
               .id(new ResourceLocation("geckolib3", "bike"), id++)
               .tracker(160, 2, false)
               .build()
         );
      event.getRegistry()
         .register(
            EntityEntryBuilder.create()
               .entity(GeoExampleEntity.class)
               .name("Example")
               .id(new ResourceLocation("geckolib3", "example"), id++)
               .tracker(160, 2, false)
               .build()
         );
      event.getRegistry()
         .register(
            EntityEntryBuilder.create()
               .entity(GeoExampleEntityLayer.class)
               .name("ExampleLayer")
               .id(new ResourceLocation("geckolib3", "examplelayer"), id++)
               .tracker(160, 2, false)
               .build()
         );
   ...
   public void onRegisterItems(Register<Item> event) {
      ...
      ItemRegistry.POTATO_HEAD = registerItem(new PotatoArmorItem(ArmorMaterial.DIAMOND, 0, EntityEquipmentSlot.HEAD), "potato_head");
      ItemRegistry.POTATO_CHEST = registerItem(new PotatoArmorItem(ArmorMaterial.DIAMOND, 0, EntityEquipmentSlot.CHEST), "potato_chest");
      ItemRegistry.POTATO_LEGGINGS = registerItem(new PotatoArmorItem(ArmorMaterial.DIAMOND, 0, EntityEquipmentSlot.LEGS), "potato_leggings");
      ItemRegistry.POTATO_BOOTS = registerItem(new PotatoArmorItem(ArmorMaterial.DIAMOND, 0, EntityEquipmentSlot.FEET), "potato_boots");
