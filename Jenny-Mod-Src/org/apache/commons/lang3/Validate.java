...
public class Validate {
   ...
   public static <T> T[] notEmpty(T[] array, String message, Object... values) {
      Objects.requireNonNull((T)array, () -> String.format(message, values));
      if (array.length == 0) {
         throw new IllegalArgumentException(String.format(message, values));
      } else {
         return array;
   ...
   public static <T> T[] notEmpty(T[] array) {
      return (T[])notEmpty(array, "The validated array is empty");
   }
   ...
   public static <T> T[] noNullElements(T[] array) {
      return (T[])noNullElements(array, "The validated array contains null element at index: %d");
   }
   ...
   public static <T> T[] validIndex(T[] array, int index) {
      return (T[])validIndex(array, index, "The validated array index is invalid: %d", index);
   }
