...
public class aM$a implements IMessageHandler<aM, IMessage> {
   public IMessage a(aM param1, MessageContext param2) {
      ...
      // Bytecode:
      // 00: aload 1
      // 01: getfield com/schnurritv/sexmod/aM.b Z
      // 04: ifeq 18
      // 07: aload 2
      ...
      // 0e: if_acmpeq 26
      // 11: goto 18
      // 14: invokestatic com/schnurritv/sexmod/aM$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 17: athrow
      ...
      // 20: aconst_null
      // 21: areturn
      // 22: invokestatic com/schnurritv/sexmod/aM$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 25: athrow
      ...
      // 2c: aload 1
      // 2d: invokedynamic run (Lcom/schnurritv/sexmod/aM;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/schnurritv/sexmod/aM$a.lambda$onMessage$0 (Lcom/schnurritv/sexmod/aM;)V, ()V ]
