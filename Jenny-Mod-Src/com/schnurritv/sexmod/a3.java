...
public class a3 implements IMessage {
   ...
   public static class a implements IMessageHandler<a3, IMessage> {
      public IMessage a(a3 param1, MessageContext param2) {
         ...
         // Bytecode:
         // 00: aload 1
         // 01: getfield com/schnurritv/sexmod/a3.a Z
         // 04: ifeq 18
         // 07: aload 2
         ...
         // 0e: if_acmpeq 26
         // 11: goto 18
         // 14: invokestatic com/schnurritv/sexmod/a3$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 17: athrow
         ...
         // 20: aconst_null
         // 21: areturn
         // 22: invokestatic com/schnurritv/sexmod/a3$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 25: athrow
         ...
         // 2c: aload 2
         // 2d: invokedynamic run (Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/schnurritv/sexmod/a3$a.lambda$onMessage$0 (Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)V, ()V ]
