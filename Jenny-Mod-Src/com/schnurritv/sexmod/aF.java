...
public class af implements IMessage {
   ...
   public af(UUID var1, String var2) {
      this.b = var1;
      this.a = var2;
      this.c = 1;
   }

   public af(UUID var1, String var2, int var3) {
      this.b = var1;
      this.a = var2;
      this.c = var3;
   }
   ...
   public static class a implements IMessageHandler<af, IMessage> {
      public IMessage a(af param1, MessageContext param2) {
         ...
         // Bytecode:
         // 00: aload 1
         // 01: getfield com/schnurritv/sexmod/af.d Z
         // 04: ifeq 1b
         // 07: aload 2
         ...
         // 11: ifne 29
         // 14: goto 1b
         // 17: invokestatic com/schnurritv/sexmod/af$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 1a: athrow
         ...
         // 23: aconst_null
         // 24: areturn
         // 25: invokestatic com/schnurritv/sexmod/af$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 28: athrow
         // 29: aload 1
         // 2a: getfield com/schnurritv/sexmod/af.b Ljava/util/UUID;
         // 2d: invokestatic com/schnurritv/sexmod/bi.i (Ljava/util/UUID;)Ljava/util/ArrayList;
         // 30: astore 3
         // 31: aload 3
         ...
         // 48: checkcast com/schnurritv/sexmod/bi
         // 4b: astore 5
         // 4d: aload 5
         // 4f: getfield com/schnurritv/sexmod/bi.field_70170_p Lnet/minecraft/world/World;
         // 52: getfield net/minecraft/world/World.field_72995_K Z
         // 55: ifne 5f
         // 58: goto 37
         // 5b: invokestatic com/schnurritv/sexmod/af$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 5e: athrow
         // 5f: bipush 0
         // 60: istore 6
         // 62: iload 6
         // 64: aload 1
         // 65: getfield com/schnurritv/sexmod/af.c I
         // 68: if_icmpge 81
         // 6b: aload 1
         // 6c: getfield com/schnurritv/sexmod/af.a Ljava/lang/String;
         ...
         // 72: aload 5
         // 74: invokestatic com/schnurritv/sexmod/bi.a (Lnet/minecraft/util/EnumParticleTypes;Lcom/schnurritv/sexmod/bi;)V
         // 77: iinc 6 1
         // 7a: goto 62
         // 7d: invokestatic com/schnurritv/sexmod/af$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 80: athrow
         // 81: goto 84
         // 84: aconst_null
         // 85: areturn
