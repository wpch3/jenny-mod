...
public class m extends Item implements IAnimatable {
   ...
   public static void a() {
      ...
      MinecraftForge.EVENT_BUS.register(m.class);
   }
   ...
   public static void a(ModelRegistryEvent var0) {
      ...
      b.setTileEntityItemStackRenderer(new bS());
   }
   ...
   public static class a {
      ...
      public void a(RightClickItem param1) {
         ...
         // 09: ifne 11
         // 0c: return
         // 0d: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 10: athrow
         // 11: aload 1
         ...
         // 20: getstatic com/schnurritv/sexmod/m.b Lcom/schnurritv/sexmod/m;
         // 23: if_acmpeq 42
         // 26: aload 3
         ...
         // 30: getstatic com/schnurritv/sexmod/m.b Lcom/schnurritv/sexmod/m;
         // 33: if_acmpeq 42
         // 36: goto 3d
         // 39: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 3c: athrow
         // 3d: return
         // 3e: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 41: athrow
         // 42: getstatic com/schnurritv/sexmod/cA.aM Ljava/util/List;
         // 45: invokeinterface java/util/List.isEmpty ()Z 1
         // 4a: ifeq 52
         // 4d: return
         // 4e: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 51: athrow
         // 52: aload 0
         // 53: invokevirtual com/schnurritv/sexmod/m$a.a ()V
         // 56: return
      ...
      @SideOnly(Side.CLIENT)
      void a() {
         Minecraft.func_71410_x().func_147108_a(new aB());
         at.a.sendToServer(new b7());
      }
      ...
      public void a(RightClickBlock param1) {
         ...
         // 0f: getstatic com/schnurritv/sexmod/m.b Lcom/schnurritv/sexmod/m;
         // 12: if_acmpeq 31
         // 15: aload 2
         ...
         // 1f: getstatic com/schnurritv/sexmod/m.b Lcom/schnurritv/sexmod/m;
         // 22: if_acmpeq 31
         // 25: goto 2c
         // 28: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 2b: athrow
         // 2c: return
         // 2d: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 30: athrow
         // 31: aload 1
         ...
         // 5c: goto 63
         // 5f: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 62: athrow
         // 63: aload 3
         ...
         // 7d: goto 84
         // 80: invokestatic com/schnurritv/sexmod/m$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 83: athrow
         // 84: return
