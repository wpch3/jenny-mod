...
public class h extends GuiScreen {
   ...
   public void func_73866_w_() {
      super.func_73866_w_();
      this.e = new GuiTextField(0, this.field_146297_k.field_71466_p, this.field_146294_l / 2 - 50, this.field_146295_m / 2 - 10, 100, 20);
      this.e.func_146195_b(true);
      this.field_146292_n.add(new GuiButton(0, this.field_146294_l / 2 - 25, this.field_146295_m / 2 + 20, 50, 20, "set"));
   }

   public void func_73876_c() {
      this.e.func_146178_a();
      super.func_73876_c();
   }

   public void func_73863_a(int var1, int var2, float var3) {
      this.func_146279_a("Name Tribe", this.field_146294_l / 2 - 39, this.field_146295_m / 2 - 10);
      this.e.func_146194_f();
      super.func_73863_a(var1, var2, var3);
   }

   protected void func_73869_a(char var1, int var2) throws IOException {
      this.e.func_146201_a(var1, var2);
      String var3 = this.e.func_146179_b();

      try {
         if (var3.length() > 15) {
            this.e.func_146180_a(var3.substring(0, 15));
         }
   ...
   protected void func_146284_a(GuiButton var1) throws IOException {
      ...
      String var2 = this.e.func_146179_b().trim();
      ...
      at.a.sendToServer(new l(this.a, Minecraft.func_71410_x().field_71439_g.getPersistentID(), var2));
