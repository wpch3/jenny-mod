...
public class b extends ModelBase {
   ...
   private final ModelRenderer b = new ModelRenderer(this, "glass");

   public b() {
      this.b.func_78784_a(0, 0).func_78789_a(-4.0F, -4.0F, -4.0F, 8, 8, 8);
      this.a = new ModelRenderer(this, "cube");
      this.a.func_78784_a(32, 0).func_78789_a(-4.0F, -4.0F, -4.0F, 8, 8, 8);
   }
