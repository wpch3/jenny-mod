...
public enum bj {
   ...
   public bj followUp = null;
   public boolean useBoyCam;
   public boolean hideNameTag;

   bj(int var3, boolean var4, boolean var5) {
   ...
   bj(int var3, boolean var4, boolean var5, boolean var6) {
      this(var3, var4, var5);
      this.useBoyCam = var6;
   }

   bj(int var3, boolean var4, boolean var5, boolean var6, boolean var7) {
      this(var3, var4, var5);
      this.useBoyCam = var6;
      this.hideNameTag = var7;
   }

   bj(int var3, boolean var4, boolean var5, float var6, float var7, boolean var8) {
      this.transitionTick = var3;
      this.hasPlayer = var4;
      this.autoBlink = var5;
   ...
   bj(int var3, boolean var4, boolean var5, float var6, float var7, boolean var8, boolean var9) {
      this.transitionTick = var3;
      this.hasPlayer = var4;
      this.autoBlink = var5;
      this.maxGirlPitch = var6;
   ...
   bj(int var3, boolean var4, boolean var5, boolean var6, float var7, float var8, boolean var9) {
      this.transitionTick = var3;
      this.hasPlayer = var4;
      this.autoBlink = var5;
   ...
   bj(int var3, boolean var4, boolean var5, int var6, bj var7) {
      this(var3, var4, var5);
      this.length = var6;
      this.followUp = var7;
   }

   bj(int var3, boolean var4, boolean var5, boolean var6, int var7, bj var8) {
      this(var3, var4, var5);
      this.length = var7;
      this.followUp = var8;
      this.useBoyCam = var6;
   ...
   bj(int var3, boolean var4, boolean var5, boolean var6, int var7, bj var8, float var9, float var10, boolean var11) {
      this.transitionTick = var3;
      this.hasPlayer = var4;
      this.autoBlink = var5;
      this.length = var7;
   ...
   bj(int var3, boolean var4, boolean var5, boolean var6, boolean var7, int var8, bj var9) {
      this(var3, var4, var5);
      this.length = var8;
      this.followUp = var9;
      this.useBoyCam = var7;
