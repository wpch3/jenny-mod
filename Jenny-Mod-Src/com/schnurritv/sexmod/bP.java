...
public class bp extends bM {
   ...
   public bp(RenderManager var1, AnimatedGeoModel var2) {
      super(var1, var2);
   }
   ...
   protected ItemStack a(@Nullable ItemStack var1) {
      ...
      //
      // Bytecode:
      // 00: getstatic com/schnurritv/sexmod/bp$a.a [I
      // 03: aload 0
      // 04: getfield com/schnurritv/sexmod/bp.g Lcom/schnurritv/sexmod/bi;
      // 07: invokevirtual com/schnurritv/sexmod/bi.D ()Lcom/schnurritv/sexmod/bj;
      // 0a: invokevirtual com/schnurritv/sexmod/bj.ordinal ()I
      // 0d: iaload
      // 0e: lookupswitch 50 2 1 26 2 26
      // 28: aload 0
      // 29: getfield com/schnurritv/sexmod/bp.g Lcom/schnurritv/sexmod/bi;
      // 2c: checkcast com/schnurritv/sexmod/c9
      // 2f: getfield com/schnurritv/sexmod/c9.ar Lnet/minecraft/item/ItemStack;
      // 32: astore 2
      // 33: aload 0
      // 34: getfield com/schnurritv/sexmod/bp.g Lcom/schnurritv/sexmod/bi;
      // 37: getstatic net/minecraft/util/EnumHand.MAIN_HAND Lnet/minecraft/util/EnumHand;
      // 3a: aload 2
      // 3b: invokevirtual com/schnurritv/sexmod/bi.func_184611_a (Lnet/minecraft/util/EnumHand;Lnet/minecraft/item/ItemStack;)V
      // 3e: aload 2
      // 3f: areturn
      // 40: aload 1
      // 41: areturn
   ...
   protected void a(String var1, GeoBone var2) {
      ...
      label96: {
         ...
         if (this.E > 0.0F) {
            double var5 = this.E / b1.b(45.0F);
            float var7 = (float)b1.a(0.0, 0.75, var5);
            var2.setPositionZ(var7);
            var2.setPositionY(var7);
            var2.setRotationX(-this.E);
         }
   ...
   protected void a(boolean param1, boolean param2) {
      ...
      // 0b: ifeq 22
      // 0e: goto 15
      // 11: invokestatic com/schnurritv/sexmod/bp.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 14: athrow
      // 15: ldc 120.0
      // 17: fconst_0
      // 18: fconst_1
      ...
      // 1d: return
      // 1e: invokestatic com/schnurritv/sexmod/bp.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 21: athrow
      // 22: iload 1
      // 23: ifne 48
      // 26: iload 2
      // 27: ifne 48
      // 2a: goto 31
      // 2d: invokestatic com/schnurritv/sexmod/bp.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 30: athrow
      // 31: dconst_0
      // 32: ldc2_w 0.3
      // 35: ldc2_w -0.15
      ...
      // 43: return
      // 44: invokestatic com/schnurritv/sexmod/bp.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 47: athrow
      // 48: iload 1
      // 49: ifeq 66
      // 4c: iload 2
      // 4d: ifne 66
      // 50: goto 57
      // 53: invokestatic com/schnurritv/sexmod/bp.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 56: athrow
      // 57: ldc2_w -0.025
      // 5a: ldc2_w -0.05
      // 5d: dconst_0
      ...
      // 61: return
      // 62: invokestatic com/schnurritv/sexmod/bp.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 65: athrow
      // 66: return
