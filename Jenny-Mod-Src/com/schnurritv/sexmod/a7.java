...
public class a7 extends Container {
   bi a;
   public Slot[] c;
   public UUID d;
   public static List<a7> b = new ArrayList<>();

   public a7(bi var1, InventoryPlayer var2, UUID var3) {
      this.d = var3;
      b.add(this);
      if (var1.hasCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.NORTH)) {
         ...
         this.a = var1;
         this.c = new Slot[]{
            new b2(b2.a.WEAPON, var4, b2.a.WEAPON.id, 31, 60),
            new b2(b2.a.BOW, var4, b2.a.BOW.id, 50, 60),
            new b2(b2.a.HELMET, var4, b2.a.HELMET.id, 72, 60),
            new b2(b2.a.CHEST_PLATE, var4, b2.a.CHEST_PLATE.id, 91, 60),
            new b2(b2.a.PANTS, var4, b2.a.PANTS.id, 110, 60),
            new b2(b2.a.SHOES, var4, b2.a.SHOES.id, 129, 60)
         };
   ...
   public ItemStack func_82846_b(EntityPlayer param1, int param2) {
      ...
      // 03: astore 3
      // 04: aload 0
      // 05: getfield com/schnurritv/sexmod/a7.field_75151_b Ljava/util/List;
      // 08: iload 2
      ...
      // 1d: ifeq ae
      // 20: goto 27
      // 23: invokestatic com/schnurritv/sexmod/a7.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 26: athrow
      // 27: aload 4
      ...
      // 33: astore 3
      // 34: aload 0
      // 35: getfield com/schnurritv/sexmod/a7.field_75151_b Ljava/util/List;
      ...
      // 53: iload 6
      // 55: aload 0
      // 56: getfield com/schnurritv/sexmod/a7.field_75151_b Ljava/util/List;
      // 59: invokeinterface java/util/List.size ()I 1
      // 5e: bipush 1
      // 5f: invokevirtual com/schnurritv/sexmod/a7.func_75135_a (Lnet/minecraft/item/ItemStack;IIZ)Z
      // 62: ifne 89
      // 65: goto 6c
      // 68: invokestatic com/schnurritv/sexmod/a7.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 6b: athrow
      // 6c: getstatic net/minecraft/item/ItemStack.field_190927_a Lnet/minecraft/item/ItemStack;
      // 6f: areturn
      // 70: invokestatic com/schnurritv/sexmod/a7.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 73: athrow
      // 74: aload 0
      // 75: aload 5
      // 77: bipush 0
      // 78: iload 6
      // 7a: bipush 0
      // 7b: invokevirtual com/schnurritv/sexmod/a7.func_75135_a (Lnet/minecraft/item/ItemStack;IIZ)Z
      // 7e: ifne 89
      // 81: getstatic net/minecraft/item/ItemStack.field_190927_a Lnet/minecraft/item/ItemStack;
      // 84: areturn
      // 85: invokestatic com/schnurritv/sexmod/a7.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 88: athrow
      // 89: aload 5
      ...
      // 99: goto a5
      // 9c: invokestatic com/schnurritv/sexmod/a7.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 9f: athrow
      // a0: aload 4
