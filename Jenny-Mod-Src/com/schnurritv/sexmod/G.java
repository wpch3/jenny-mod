...
public class g extends Item implements IAnimatable {
   ...
   public static void a() {
      b.setRegistryName("sexmod", "kobold_egg_item");
      b.func_77655_b("kobold_egg_item");
      MinecraftForge.EVENT_BUS.register(g.class);
   }
   ...
   public static void a(ModelRegistryEvent var0) {
      ...
      ModelLoader.setCustomMeshDefinition(b, var1x -> var1);
      ModelBakery.registerItemVariants(b, new ResourceLocation[]{var1});
      b.setTileEntityItemStackRenderer(new bR());
   }
   ...
   public static void a(RightClickBlock var0) {
      ...
      var4.func_184212_Q().func_187227_b(c7.c, EyeAndKoboldColor.getColorByWoolId(var2.func_77960_j()).toString());
      NBTTagCompound var5 = var2.func_77978_p();

      try {
         if (var5 != null) {
            var4.a = UUID.fromString(var5.func_74779_i("tribeID"));
         }
