...
public class cD$a implements IMessageHandler<cD, IMessage> {
   public IMessage a(cD param1, MessageContext param2) {
      ...
      // Bytecode:
      // 00: aload 1
      // 01: getfield com/schnurritv/sexmod/cD.a Z
      // 04: ifeq 18
      // 07: aload 2
      ...
      // 0e: if_acmpeq 26
      // 11: goto 18
      // 14: invokestatic com/schnurritv/sexmod/cD$a.a (Ljava/lang/NullPointerException;)Ljava/lang/NullPointerException;
      // 17: athrow
      ...
      // 20: aconst_null
      // 21: areturn
      // 22: invokestatic com/schnurritv/sexmod/cD$a.a (Ljava/lang/NullPointerException;)Ljava/lang/NullPointerException;
      // 25: athrow
      ...
      // 2c: aload 1
      // 2d: invokedynamic run (Lcom/schnurritv/sexmod/cD;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/schnurritv/sexmod/cD$a.lambda$onMessage$0 (Lcom/schnurritv/sexmod/cD;)V, ()V ]
