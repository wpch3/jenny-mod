...
public class O implements IMessage {
   ...
   public static class a implements IMessageHandler<O, IMessage> {
      public IMessage a(O param1, MessageContext param2) {
         ...
         // Bytecode:
         // 00: aload 1
         // 01: getfield com/schnurritv/sexmod/O.b Ljava/lang/Boolean;
         ...
         // 14: ifne 2c
         // 17: goto 1e
         // 1a: invokestatic com/schnurritv/sexmod/O$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 1d: athrow
         ...
         // 26: aconst_null
         // 27: areturn
         // 28: invokestatic com/schnurritv/sexmod/O$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 2b: athrow
         ...
         // 33: aload 2
         // 34: aload 1
         // 35: invokedynamic run (Lcom/schnurritv/sexmod/O$a;Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;Lcom/schnurritv/sexmod/O;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/schnurritv/sexmod/O$a.lambda$onMessage$0 (Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;Lcom/schnurritv/sexmod/O;)V, ()V ]
      ...
      BlockPos a(World var1, BlockPos var2) {
         ...
         try {
            return var1.func_180495_p(var2.func_177982_a(1, -1, -1)).func_177230_c() instanceof BlockLog ? this.a(var1, var2.func_177982_a(1, -1, -1)) : var2;
