...
public class bu extends bN {
   public bu(RenderManager var1, AnimatedGeoModel var2) {
      super(var1, var2);
   }

   @Override
   protected Vec3i c(String param1) {
      ...
      // Bytecode:
      // 00: aload 0
      // 01: getfield com/schnurritv/sexmod/bu.g Lcom/schnurritv/sexmod/bi;
      // 04: invokevirtual com/schnurritv/sexmod/bi.func_184212_Q ()Lnet/minecraft/network/datasync/EntityDataManager;
      // 07: astore 2
      // 08: aload 2
      // 09: getstatic com/schnurritv/sexmod/cA.G Lnet/minecraft/network/datasync/DataParameter;
      ...
      // 12: invokestatic com/schnurritv/sexmod/EyeAndKoboldColor.valueOf (Ljava/lang/String;)Lcom/schnurritv/sexmod/EyeAndKoboldColor;
      // 15: astore 3
      // 16: aload 2
      // 17: getstatic com/schnurritv/sexmod/cA.H Lnet/minecraft/network/datasync/DataParameter;
      ...
      // 20: astore 4
      // 22: getstatic com/schnurritv/sexmod/bf.A Ljava/util/HashSet;
      // 25: aload 1
      // 26: invokevirtual java/util/HashSet.contains (Ljava/lang/Object;)Z
      // 29: ifeq 35
      // 2c: aload 3
      // 2d: invokevirtual com/schnurritv/sexmod/EyeAndKoboldColor.getMainColor ()Lnet/minecraft/util/math/Vec3i;
      // 30: areturn
      // 31: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 34: athrow
      // 35: getstatic com/schnurritv/sexmod/bf.z Ljava/util/HashSet;
      // 38: aload 1
      // 39: invokevirtual java/util/HashSet.contains (Ljava/lang/Object;)Z
      // 3c: ifeq 48
      // 3f: aload 3
      // 40: invokevirtual com/schnurritv/sexmod/EyeAndKoboldColor.getSecondaryColor ()Lnet/minecraft/util/math/Vec3i;
      // 43: areturn
      // 44: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 47: athrow
      // 48: ldc "irisR"
      // 4a: aload 1
      ...
      // 57: ifeq 68
      // 5a: goto 61
      // 5d: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 60: athrow
      // 61: aload 4
      // 63: areturn
      // 64: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 67: athrow
      // 68: getstatic com/schnurritv/sexmod/bu.E Lnet/minecraft/util/math/Vec3i;
      // 6b: areturn
   ...
   @Override
   protected void d() {
      float var1 = 0.25F - (Float)this.g.func_184212_Q().func_187225_a(cn.ax);
   ...
   protected void a(boolean param1, ItemStack param2) {
      ...
      // 01: iload 1
      // 02: aload 2
      // 03: invokespecial com/schnurritv/sexmod/bN.a (ZLnet/minecraft/item/ItemStack;)V
      // 06: aload 2
      ...
      // 15: ifne 2e
      // 18: goto 1f
      // 1b: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 1e: athrow
      // 1f: ldc 170.0
      // 21: fconst_1
      // 22: fconst_0
      ...
      // 27: goto 2e
      // 2a: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 2d: athrow
      // 2e: iload 1
      // 2f: ifeq 40
      // 32: ldc 0.1
      ...
      // 39: goto 40
      // 3c: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 3f: athrow
      // 40: return
      // 41: iload 1
      // 42: ifeq 4e
      // 45: ldc 80.0
      // 47: goto 50
      // 4a: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 4d: athrow
      // 4e: ldc 180.0
      // 50: fconst_1
      // 51: fconst_0
   ...
   protected void a(boolean param1, boolean param2) {
      ...
      // 01: iload 1
      // 02: iload 2
      // 03: invokespecial com/schnurritv/sexmod/bN.a (ZZ)V
      // 06: iload 1
      // 07: ifeq 53
      // 0a: iload 2
      // 0b: ifeq 3e
      // 0e: goto 15
      // 11: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 14: athrow
      // 15: ldc2_w 0.06
      // 18: dconst_0
      // 19: ldc2_w -0.13
      ...
      // 37: goto 78
      // 3a: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 3d: athrow
      // 3e: ldc 90.0
      // 40: fconst_1
      // 41: fconst_0
      ...
      // 67: goto 78
      // 6a: invokestatic com/schnurritv/sexmod/bu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
      // 6d: athrow
      // 6e: dconst_0
      // 6f: ldc2_w -0.1
