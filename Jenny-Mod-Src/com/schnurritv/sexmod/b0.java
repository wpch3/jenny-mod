...
public class b0 implements IMessage {
   ...
   public b0(String var1, Vec3d var2) {
      this.a = var1;
      this.e = var2;
      this.c = 0.0F;
      this.b = 0.0F;
   ...
   public b0(String var1, Vec3d var2, float var3, float var4) {
      this.a = var1;
      this.e = var2;
      this.c = var3;
      this.b = var4;
   ...
   public b0(String var1, double var2, double var4, double var6, float var8, float var9) {
      this.a = var1;
   ...
   public static class a implements IMessageHandler<b0, IMessage> {
      public IMessage a(b0 param1, MessageContext param2) {
         ...
         // Bytecode:
         // 00: aload 1
         // 01: getfield com/schnurritv/sexmod/b0.d Z
         // 04: ifeq 18
         // 07: aload 2
         ...
         // 0e: if_acmpeq 26
         // 11: goto 18
         // 14: invokestatic com/schnurritv/sexmod/b0$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 17: athrow
         ...
         // 20: aconst_null
         // 21: areturn
         // 22: invokestatic com/schnurritv/sexmod/b0$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
         // 25: athrow
         ...
         // 2c: aload 1
         // 2d: invokedynamic run (Lcom/schnurritv/sexmod/b0;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/schnurritv/sexmod/b0$a.lambda$onMessage$0 (Lcom/schnurritv/sexmod/b0;)V, ()V ]
