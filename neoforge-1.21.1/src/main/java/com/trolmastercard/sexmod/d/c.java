...
import com.trolmastercard.sexmod.f.g;
...
public class c {
    private static final HashMap<UUID, c.a> e = new HashMap<>();
    static c.b a;
    ...
    static HashMap<h, BlockPos[]> c = new HashMap<>();
    public static final Factory<c.b> d = new Factory(c.b::new, c.b::a, DataFixTypes.LEVEL);
    ...
    public static void a(UUID var0, com.trolmastercard.sexmod.a var1) {
        c.a var2 = e.get(var0);
        if (var2 != null) {
            System.out.println("tribe of UUID " + var0.toString() + " does already exist lol");
        } else {
            e.put(var0, new c.a(var0, var1));
            a();
        }
    }
    ...
    public static void a(Level var0, Vec3 var1) {
        ...
        for (float var8 : var3) {
            h var9 = h.a(var0, var2, var8);
            if (var9 != null) {
                var10.add(var9);
            }
        }

        com.trolmastercard.sexmod.a var11 = com.trolmastercard.sexmod.a.values()[f.a.nextInt(com.trolmastercard.sexmod.a.values().length)];
        a(var2, var11);
    ...
    public static void a(UUID var0, h var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
    ...
    public static void b(UUID var0, h var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
        } else {
            var2.a(var1);
            e.replace(var0, var2);
            var1.getEntityData().set(h.i, var0.toString());
            if (!var1.G) {
                var1.getEntityData().set(n.U, var2.e.name());
            }
        }
    }
    ...
    public static void c(UUID var0, h var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
        } else {
    ...
    public static boolean d(UUID var0, h var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
            return false;
    ...
    public static List<h> d(UUID var0) {
        c.a var1 = e.get(var0);
        if (var1 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
    ...
    public static com.trolmastercard.sexmod.a g(UUID var0) {
        c.a var1 = e.get(var0);
        if (var1 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
            return com.trolmastercard.sexmod.a.d;
        } else {
            return var1.e;
        }
    }
    ...
    public static BlockPos[] a(h var0) {
        return c.get(var0);
    }

    public static void a(h var0, BlockPos var1) {
    ...
    @Nullable
    public static Collection<d> j(UUID var0) {
        c.a var1 = e.get(var0);
        if (var1 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
            return null;
    ...
    public static HashSet<BlockPos> a(UUID var0, d var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
            return new HashSet<>();
    ...
    public static void b(UUID var0, d var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
        } else {
    ...
    public static void e(UUID var0, h var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
        } else {
    ...
    public static void a(UUID var0, g var1) {
        c.a var2 = e.get(var0);
        if (var2 == null) {
            System.out.println("tribe of UUID " + var0.toString() + " not found uwu");
        } else {
    ...
    public static UUID n(UUID var0) {
        ...
        for (Entry var2 : e.entrySet()) {
            c.a var3 = (c.a)var2.getValue();
            if ((var3.b().size() != 0 || var3.c() != 0) && var0.equals(((c.a)var2.getValue()).a())) {
    ...
    public static UUID o(UUID var0) {
        ...
        String var4 = (String)((h)var2.get(0)).getEntityData().get(k.ao);
        return UUID.fromString(var4);
    }

    public static c.b a(ServerLevel var0) {
        c.b var1 = (c.b)var0.getDataStorage().computeIfAbsent(d, "sexmod_tribes");
        a = var1;
        return var1;
    }
    ...
    public static class a {
        ...
        boolean l = false;
        Collection<d> m = new ArrayList<>();
        String n = "";
        boolean o = false;

        public a(UUID var1, com.trolmastercard.sexmod.a var2) {
            this.a = var1;
            this.e = var2;
        ...
        public void b(d var1) {
            if (this.m.contains(var1)) {
                for (h var3 : var1.e()) {
                    ...
                    var3.getEntityData().set(k.ap, false);
                }
        ...
        public void a(h var1) {
            if (!this.d.contains(var1)) {
                ...
                for (h var7 : var3) {
                    Main.a.warn(String.format("Removed old entry of kobold called %s with UUID %s owned by %s", var7.a(), var7.ah(), this.b));
                    this.b(var7);
                }
            ...
            for (h var3 : this.d) {
                if (!var3.isRemoved()) {
                    if (var1 == null) {
                        ...
                        float var4 = (Float)var1.getEntityData().get(h.b);
                        float var5 = (Float)var3.getEntityData().get(h.b);
                        if (var5 < var4) {
                            var1 = var3;
                        }
                    }
    ...
    public static class b extends SavedData {
        public static final Codec<c.b> a = c.b.a.a.listOf().xmap(var0 -> {
            for (c.b.a var2 : var0) {
                com.trolmastercard.sexmod.d.c.a(var2.b, var2.c);
                if (var2.d.isPresent()) {
                    com.trolmastercard.sexmod.d.c.a(var2.b, var2.d.get());
                }

                for (BlockPos var4 : var2.e) {
                    com.trolmastercard.sexmod.d.c.a(var2.b, var4);
                }

                for (BlockPos var6 : var2.f) {
                    com.trolmastercard.sexmod.d.c.b(var2.b, var6);
                }

                if (!var2.g.isEmpty()) {
                    com.trolmastercard.sexmod.d.c.a(var2.b, var2.g);
                }
            }
            ...
            for (Entry var3 : com.trolmastercard.sexmod.d.c.e.entrySet()) {
                c.a var4 = (c.a)var3.getValue();
                var1.add(new c.b.a((UUID)var3.getKey(), var4.e, Optional.ofNullable(var4.a()), new ArrayList<>(var4.j), new ArrayList<>(var4.i), var4.n));
            }
        ...
        public static c.b a(CompoundTag var0, Provider var1) {
            return a.parse(NbtOps.INSTANCE, var0.get("tribes")).result().orElseGet(c.b::new);
        }

        public record a() {
            private final UUID b;
            private final com.trolmastercard.sexmod.a c;
            private final Optional<UUID> d;
            private final List<BlockPos> e;
            private final List<BlockPos> f;
            private final String g;
            static final Codec<c.b.a> a = RecordCodecBuilder.create(
                var0 -> var0.group(
                        UUIDUtil.CODEC.fieldOf("id").forGetter(c.b.a::a),
                        Codec.STRING.xmap(com.trolmastercard.sexmod.a::a, Enum::name).fieldOf("color").forGetter(c.b.a::b),
                        UUIDUtil.CODEC.optionalFieldOf("owner").forGetter(c.b.a::c),
                        BlockPos.CODEC.listOf().fieldOf("beds").forGetter(c.b.a::d),
                        BlockPos.CODEC.listOf().fieldOf("chests").forGetter(c.b.a::e),
                        Codec.STRING.optionalFieldOf("name", "").forGetter(c.b.a::f)
                    )
                    .apply(var0, c.b.a::new)
            );

            public a(UUID var1, com.trolmastercard.sexmod.a var2, Optional<UUID> var3, List<BlockPos> var4, List<BlockPos> var5, String var6) {
                this.b = var1;
                this.c = var2;
                this.d = var3;
                this.e = var4;
            ...
            public com.trolmastercard.sexmod.a b() {
                return this.c;
            }
