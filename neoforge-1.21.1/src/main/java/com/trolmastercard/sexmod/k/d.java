...
public class d extends Item {
    ...
    private void a(Level var1, ItemStack var2, double var3, double var5, double var7) {
        com.trolmastercard.sexmod.f.d var9 = (com.trolmastercard.sexmod.f.d)((EntityType)com.trolmastercard.sexmod.i.b.B.get()).create(var1);
        if (var9 != null) {
            ...
            var9.getEntityData().set(com.trolmastercard.sexmod.f.d.b, com.trolmastercard.sexmod.a.a(var11).name());
