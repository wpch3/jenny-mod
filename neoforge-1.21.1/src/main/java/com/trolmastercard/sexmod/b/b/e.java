...
public class E extends EntityRenderer<com.trolmastercard.sexmod.f.f> {
    ...
    public void a(com.trolmastercard.sexmod.f.f var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
        int var7 = 15728880;
        ...
        if (var13 == null) {
            ...
            Vec3 var14 = com.trolmastercard.sexmod.m.i.a(new Vec3(var1.xOld, var1.yOld, var1.zOld), var1.position(), var3);
            Vec3 var15 = com.trolmastercard.sexmod.m.i.a(new Vec3(var13.xOld, var13.yOld, var13.zOld), var13.position(), var3);
            ...
            if (var8 == f && this.j != f) {
                ...
                if (var19 > this.k + 60000L) {
                    DeferredHolder var21 = com.trolmastercard.sexmod.i.e.a("misc.pyro.pyro0");
                    if (var21 != null) {
    ...
    RenderType a(com.trolmastercard.sexmod.f.f var1, double var2, LocalPlayer var4) {
        if (var1.d != -1) {
    ...
    static int a(com.trolmastercard.sexmod.f.f var0, LocalPlayer var1) {
        return var0.d == -1 ? 0 : (int)com.trolmastercard.sexmod.m.j.a(var1.tickCount - var0.d, 1.0F, 30.0F);
    }

    static float a(com.trolmastercard.sexmod.f.f var0, LocalPlayer var1, float var2) {
        if (var0.d == -1) {
            return 0.0F;
        }
    ...
    static float b(com.trolmastercard.sexmod.f.f var0, LocalPlayer var1, float var2) {
        if (var0.d == -1) {
            return 1.0F;
        }
        ...
        byte var3 = 90;
        float var4 = com.trolmastercard.sexmod.m.j.a(var1.tickCount - var0.d, var3, 120.0F) - var3;
        float var5 = (var4 + var2) / 30.0F;
        return 1.0F - var5;
    }

    public ResourceLocation a(com.trolmastercard.sexmod.f.f var1) {
        return a;
    }
