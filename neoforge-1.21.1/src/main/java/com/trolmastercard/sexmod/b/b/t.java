...
public abstract class t<T extends com.trolmastercard.sexmod.f.b.k> extends GeoEntityRenderer<T> {
    ...
    protected t(Context var1, GeoModel<T> var2) {
        super(var1, var2);
    }

    private static ResourceLocation a(com.trolmastercard.sexmod.f.b.k var0) {
        UUID var1 = var0.al();
        return var1 != null && var0.level().getPlayerByUUID(var1) instanceof AbstractClientPlayer var3 ? var3.getSkin().texture() : c;
    }

    private static boolean b(com.trolmastercard.sexmod.f.b.k var0) {
    ...
    public void b(
        ...
        if (!var6 && b(var2)) {
            var3.getBone("steve").ifPresent(var9x -> {
                ...
                this.a(var1, (T)var2, var9x, var10x, var4, var4.getBuffer(var10x), true, var7, var8, var9, var10);
                b(var3, true);
                a(var3, false);
                RenderType var11 = RenderType.entityCutoutNoCull(c);
                this.a(var1, (T)var2, var9x, var11, var4, var4.getBuffer(var11), true, var7, var8, var9, var10);
                b(var3, false);
            });
        }
    }
