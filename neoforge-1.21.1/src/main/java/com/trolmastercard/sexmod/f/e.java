...
public class e extends Entity {
    private static final EntityDataAccessor<String> c = SynchedEntityData.defineId(e.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Integer> d = SynchedEntityData.defineId(e.class, EntityDataSerializers.INT);
    private boolean e;
    private int f;
    private int g;
    public int a;
    ...
    public e(EntityType<? extends Entity> var1, Level var2) {
        super(var1, var2);
    }

    public e(EntityType<? extends Entity> var1, Level var2, com.trolmastercard.sexmod.f.b.i var3, double var4) {
        this(var1, var2);
        this.a(var3);
        var3.g = this;
        this.a(var4);
    ...
    public void a(@Nullable com.trolmastercard.sexmod.f.b.i var1) {
    ...
    @Nullable
    com.trolmastercard.sexmod.f.b.i a() {
        String var1 = (String)this.getEntityData().get(c);
        if ("".equals(var1)) {
            return null;
        } else {
            return com.trolmastercard.sexmod.f.b.k.t(UUID.fromString(var1)) instanceof com.trolmastercard.sexmod.f.b.i var3 ? var3 : null;
        }
    }

    @Nullable
    com.trolmastercard.sexmod.f.b.i b() {
        String var1 = (String)this.getEntityData().get(c);
        if ("".equals(var1)) {
            return null;
        } else {
            return com.trolmastercard.sexmod.f.b.k.s(UUID.fromString(var1)) instanceof com.trolmastercard.sexmod.f.b.i var3 ? var3 : null;
        }
    }

    @Nullable
    public com.trolmastercard.sexmod.f.b.i c() {
        return this.b();
    }
    ...
    public void baseTick() {
        ...
        if (!this.level().isClientSide()) {
            if (this.b != null || this.onGround()) {
                if (this.a == 0) {
                    com.trolmastercard.sexmod.f.b.i var1 = this.a();
                    if (var1 != null) {
                        var1.n();
                    }
                }
    ...
    public void a(double var1) {
        com.trolmastercard.sexmod.f.b.i var3 = this.a();
        if (var3 != null) {
        ...
        if (!this.level().isClientSide() && this.a() != null) {
            ...
            if (this.b != null) {
                ...
                for (ItemStack var6 : var2.getServer().reloadableRegistries().getLootTable(BuiltInLootTables.FISHING).getRandomItems(var3)) {
                    com.trolmastercard.sexmod.f.b.i var7 = this.a();
                    var7.a(var6);
                }
