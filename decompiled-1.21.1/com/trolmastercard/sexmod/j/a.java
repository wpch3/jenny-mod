...
public class a extends AbstractContainerMenu {
    private static final int[] a = new int[]{31, 50, 72, 91, 110, 129};
    private final Container b;

    public a(int var1, Inventory var2, l var3) {
        this(var1, var2, new c(var3));
    }

    public a(int var1, Inventory var2, int var3) {
        this(var1, var2, a(var2, var3));
    }

    private a(int var1, Inventory var2, Container var3) {
        super((MenuType)d.b.get(), var1);
        this.b = var3;
    ...
    private static Container a(Inventory var0, int var1) {
        return (Container)(var0.player.level().getEntity(var1) instanceof l var3 ? new c(var3) : new SimpleContainer(7));
    }
