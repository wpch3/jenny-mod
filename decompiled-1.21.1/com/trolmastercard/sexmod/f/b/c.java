...
public class c extends l implements p {
    ...
    public c(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
        this.B = 140;
        this.C = 50;
        this.D = 140;
    ...
    public void i_() {
        ...
        com.trolmastercard.sexmod.i.e.a(this, "bia", "breath");
    }
    ...
    public void c(com.trolmastercard.sexmod.f.j var1) {
        ...
        if (var2 == com.trolmastercard.sexmod.f.j.Y || var2 == com.trolmastercard.sexmod.f.j.bz) {
            this.entityData.set(k.av, "");
        }

        if (var2 != com.trolmastercard.sexmod.f.j.Y || var1 != com.trolmastercard.sexmod.f.j.X && var1 != com.trolmastercard.sexmod.f.j.W) {
            if (var2 != com.trolmastercard.sexmod.f.j.bz || var1 != com.trolmastercard.sexmod.f.j.bx && var1 != com.trolmastercard.sexmod.f.j.bw) {
                super.c(var1);
            }
        }
    }
    ...
    protected void customServerAiStep() {
        ...
        if (this.a) {
            this.b++;
            if (!this.position().equals(k.aq) && this.b <= 40) {
                this.setYRot(this.e_());
                this.d(this.aE());
                this.setNoGravity(false);
                Vec3 var3 = com.trolmastercard.sexmod.m.i.a(this.position(), this.am(), 40 - this.b);
        ...
        if (this.c) {
            if (!(this.position().distanceTo(this.am()) < 0.6) && this.d <= 200) {
                ...
                if ("anal".equals(this.entityData.get(k.av))) {
                    this.c(com.trolmastercard.sexmod.f.j.T);
                    this.d(0);
                } else {
                    this.c(com.trolmastercard.sexmod.f.j.u);
                }
            }
        }
    }
    ...
    public boolean a(Player var1) {
        ...
        if (this.aw() && !((String)this.entityData.get(k.ao)).equals(com.trolmastercard.sexmod.b.b.a().toString())) {
            return false;
        }

        String[] var2 = new String[]{
            this.entityData.get(k.at) == 1 ? "action.names.strip" : "action.names.dressup", "action.names.talk", "action.names.headpat"
        };
    ...
    public void tick() {
        super.tick();
        if (this.level().isClientSide() && this.aB() && this.ai() == com.trolmastercard.sexmod.f.j.bv) {
    ...
    void e() {
        ...
        if (var1 == com.trolmastercard.sexmod.f.j.U || var1 == com.trolmastercard.sexmod.f.j.v) {
            ...
            if (var2 != null) {
                if (!(var2.distanceTo(this) > 1.0F)) {
                    if (this.f == -1) {
                        ...
                        if (var1 == com.trolmastercard.sexmod.f.j.U) {
                            if (!this.level().isClientSide()) {
                                this.c(com.trolmastercard.sexmod.f.j.V);
                                Vec3 var7 = this.am().add(com.trolmastercard.sexmod.m.o.a(-0.3, -1.0, -0.5, this.e_()));
                            ...
                            if (!this.level().isClientSide()) {
                                this.d(0);
                                this.c(com.trolmastercard.sexmod.f.j.bv);
                                Vec3 var4 = this.am();
                                Vec3 var5 = var4.add(com.trolmastercard.sexmod.m.o.a(0.0, 0.0, 1.0, var3));
                                this.d(var5);
                                Vec3 var6 = var4.add(com.trolmastercard.sexmod.m.o.a(0.0, 1.1875 - var2.getEyeHeight(), 0.5, var3));
    ...
    public void a(String var1, UUID var2) {
        ...
        if ("action.names.talk".equals(var1)) {
            this.q(com.trolmastercard.sexmod.b.b.a());
            this.a("playerSheHasSexWith", com.trolmastercard.sexmod.b.b.a().toString());
    ...
    protected com.trolmastercard.sexmod.f.j b(com.trolmastercard.sexmod.f.j var1) {
        if (var1 == com.trolmastercard.sexmod.f.j.W || var1 == com.trolmastercard.sexmod.f.j.X) {
            return com.trolmastercard.sexmod.f.j.Y;
        } else {
            return var1 != com.trolmastercard.sexmod.f.j.bw && var1 != com.trolmastercard.sexmod.f.j.bx ? null : com.trolmastercard.sexmod.f.j.bz;
        }
    }

    @Override
    protected com.trolmastercard.sexmod.f.j a_(com.trolmastercard.sexmod.f.j var1) {
        if (var1 == com.trolmastercard.sexmod.f.j.V) {
            return com.trolmastercard.sexmod.f.j.W;
        } else if (var1 == com.trolmastercard.sexmod.f.j.W) {
            return com.trolmastercard.sexmod.f.j.X;
        } else if (var1 == com.trolmastercard.sexmod.f.j.bv) {
            return com.trolmastercard.sexmod.f.j.by;
        } else if (var1 == com.trolmastercard.sexmod.f.j.by) {
            return com.trolmastercard.sexmod.f.j.bw;
        } else {
            return var1 == com.trolmastercard.sexmod.f.j.bw ? com.trolmastercard.sexmod.f.j.bx : null;
        }
    }

    @Override
    protected void c_() {
        String var1 = (String)this.entityData.get(k.av);
        if ("talkHorny".equals(var1)) {
            this.c(com.trolmastercard.sexmod.f.j.Q);
