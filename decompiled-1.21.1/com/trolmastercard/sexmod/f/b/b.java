...
public class b extends m {
    ...
    int b = 0;
    public static final EntityDataAccessor<Boolean> c = SynchedEntityData.defineId(b.class, EntityDataSerializers.BOOLEAN);

    public b(EntityType<? extends PathfinderMob> var1, Level var2) {
        super(var1, var2);
    ...
    public void c(com.trolmastercard.sexmod.f.j var1) {
        if (this.ai() != com.trolmastercard.sexmod.f.j.au || var1 != com.trolmastercard.sexmod.f.j.at && var1 != com.trolmastercard.sexmod.f.j.x) {
            super.c(var1);
        }
    }
    ...
    protected void customServerAiStep() {
        ...
        this.d();
        if (this.ai().equals(com.trolmastercard.sexmod.f.j.au)) {
    ...
    public InteractionResult mobInteract(Player var1, InteractionHand var2) {
        if ((Boolean)this.entityData.get(c) && !(Boolean)this.entityData.get(m.d) && var1.getItemInHand(var2).getItem() == Items.CHEST) {
            this.entityData.set(m.d, true);
    ...
    void b(Player var1) {
        com.trolmastercard.sexmod.h.b.a(this, var1);
    }
    ...
    public void addAdditionalSaveData(CompoundTag var1) {
        ...
        var1.putBoolean("hasChest", (Boolean)this.entityData.get(m.d));
    ...
    public void readAdditionalSaveData(CompoundTag var1) {
        ...
        this.entityData.set(m.d, var1.getBoolean("hasChest"));
        ...
        switch (var2) {
            case "movement":
                if (this.ai() == com.trolmastercard.sexmod.f.j.a) {
                    String var5 = this.entityData.get(m.d) ? "idle_has_chest" : "idle";
