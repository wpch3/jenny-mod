...
public class h extends b implements q {
    public static final EntityDataAccessor<String> s = SynchedEntityData.defineId(h.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<Boolean> t = SynchedEntityData.defineId(h.class, EntityDataSerializers.BOOLEAN);
    int u = -1;
    int v = 0;
    int w = 0;
    com.trolmastercard.sexmod.f.j x = com.trolmastercard.sexmod.f.j.a;
    int y = -1;
    boolean z = true;
    boolean O = false;
    ...
    public boolean a(Player var1) {
        com.trolmastercard.sexmod.f.b.k.a(var1, this, new String[]{"anal", "paizuri"}, false);
        return true;
    }

    @Override
    protected com.trolmastercard.sexmod.f.j a_(com.trolmastercard.sexmod.f.j var1) {
        if (var1 == com.trolmastercard.sexmod.f.j.I) {
            return com.trolmastercard.sexmod.f.j.J;
        } else if (var1 == com.trolmastercard.sexmod.f.j.bo) {
            return com.trolmastercard.sexmod.f.j.bp;
        } else {
            return var1 == com.trolmastercard.sexmod.f.j.bc ? com.trolmastercard.sexmod.f.j.bf : null;
        }
    }

    @Override
    protected com.trolmastercard.sexmod.f.j b(com.trolmastercard.sexmod.f.j var1) {
        if (var1 == com.trolmastercard.sexmod.f.j.I || var1 == com.trolmastercard.sexmod.f.j.J) {
            return com.trolmastercard.sexmod.f.j.L;
        } else if (var1 == com.trolmastercard.sexmod.f.j.bo || var1 == com.trolmastercard.sexmod.f.j.bp) {
            return com.trolmastercard.sexmod.f.j.bq;
        } else {
            return var1 != com.trolmastercard.sexmod.f.j.bc && var1 != com.trolmastercard.sexmod.f.j.bf ? null : com.trolmastercard.sexmod.f.j.bh;
        }
    }
    ...
    protected String a(StringBuilder var1) {
        com.trolmastercard.sexmod.f.b.n.c(var1, 3);
        com.trolmastercard.sexmod.f.b.n.c(var1, 2);
        com.trolmastercard.sexmod.f.b.n.c(var1, 2);
        com.trolmastercard.sexmod.f.b.n.c(var1, 7);
        com.trolmastercard.sexmod.f.b.n.c(var1, 7);
        com.trolmastercard.sexmod.f.b.n.c(var1, 5);
        com.trolmastercard.sexmod.f.b.n.c(var1, com.trolmastercard.sexmod.m.f.values().length - 1);
        com.trolmastercard.sexmod.f.b.n.c(var1, com.trolmastercard.sexmod.m.g.values().length - 1);
        com.trolmastercard.sexmod.f.b.n.c(var1, com.trolmastercard.sexmod.m.h.values().length - 1);
        com.trolmastercard.sexmod.f.b.n.b(var1, 0);
    ...
    public void a(List<Integer> var1) {
        ...
        for (int var4 : var1) {
            com.trolmastercard.sexmod.f.b.n.b(var2, var4);
        }

        com.trolmastercard.sexmod.f.b.n.b(var2, 1);
    ...
    @Override
    public void tick() {
        com.trolmastercard.sexmod.f.b.f.d(this);
        this.z();
        this.y();
        super.tick();
    }
    ...
    protected void customServerAiStep() {
        ...
        com.trolmastercard.sexmod.f.b.f.e(this);
        this.A();
        this.B();
    }
    ...
    void y() {
        ...
        if (var1 != com.trolmastercard.sexmod.f.j.aV) {
            if (var1 != com.trolmastercard.sexmod.f.j.aU || this.C() <= 15) {
                UUID var2 = this.g_();
                if (var2 != null) {
    ...
    void z() {
        ...
        if (var1 != -1) {
            ...
            if (var2 != null) {
                if (var1 == 15) {
                    float var3 = com.trolmastercard.sexmod.f.b.f.c(this);
                    float var4 = com.trolmastercard.sexmod.f.b.f.b(this);
                    Vec3 var5 = com.trolmastercard.sexmod.f.b.f.a(new Vec3(0.0, 0.0, 1.5), var3, var4);
        ...
        switch (var2) {
            ...
            case "movement":
                if (this.ai() != com.trolmastercard.sexmod.f.j.a) {
                    ...
                    if (!(Boolean)this.entityData.get(com.trolmastercard.sexmod.f.b.k.ap) && var5 > 0.0) {
