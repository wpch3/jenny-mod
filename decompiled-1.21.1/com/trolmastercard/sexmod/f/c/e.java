...
import com.trolmastercard.sexmod.m.o;
...
public class e extends c.a {
    ...
    public boolean a(Player var1) {
        com.trolmastercard.sexmod.f.b.k.a(var1, this, new String[]{"action.names.headpat"}, false);
        return true;
    }
    ...
    protected com.trolmastercard.sexmod.f.j a_(com.trolmastercard.sexmod.f.j var1) {
        if (var1 == com.trolmastercard.sexmod.f.j.W) {
            ...
            return var1 == com.trolmastercard.sexmod.f.j.bv ? com.trolmastercard.sexmod.f.j.by : null;
        }
    }
    ...
    private boolean e(Player var1) {
        return com.trolmastercard.sexmod.b.b.a(var1.getUUID());
    }
                ...
                if (!(var2.distanceTo(this) > 1.0F)) {
                    if (!this.level().isClientSide() || this.e(var2)) {
                        if (this.l == -1) {
                            ...
                            this.l = com.trolmastercard.sexmod.f.b.k.af;
                        } else if (--this.l <= 0) {
                            this.l = -1;
                            var2.noPhysics = true;
                            ...
                            if (var1 == com.trolmastercard.sexmod.f.j.U) {
                                if (!this.level().isClientSide()) {
                                    ...
                                    Vec3 var8 = this.am().add(o.a(-0.3, -1.0, -0.5, this.e_()));
                                ...
                                if (!this.level().isClientSide()) {
                                    ...
                                    Vec3 var4 = this.am();
                                    Vec3 var5 = var4.add(o.a(0.0, 0.0, 1.0, var3));
                                    this.d(var5);
                                    Player var6 = this.q();
                                    if (var6 != null) {
                                    ...
                                    Vec3 var7 = var4.add(o.a(0.0, 1.1875 - var2.getEyeHeight(), 0.5, var3));
