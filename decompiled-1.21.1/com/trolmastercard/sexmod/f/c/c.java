...
public class c extends com.trolmastercard.sexmod.f.c.a {
    public float l = 0.0F;
    Player m = null;
    boolean n = false;
    int o = 1;
    ...
    public boolean a(Player var1) {
        com.trolmastercard.sexmod.f.b.k.a(var1, this, new String[]{"action.names.deepthroat", "Reverse cowgirl"}, false);
        return true;
    }
    ...
    protected com.trolmastercard.sexmod.f.j a_(com.trolmastercard.sexmod.f.j var1) {
        if (var1 == com.trolmastercard.sexmod.f.j.ai) {
