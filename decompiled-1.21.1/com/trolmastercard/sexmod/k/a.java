...
public class a extends Item implements GeoItem {
                ...
                if (var1.equals(var6.getMainHandItem()) || var1.equals(var6.getOffhandItem())) {
                    ...
                    if (var8) {
                        ...
                        if (var9 >= a) {
                            ...
                            a(var1, a(var1) + 1);
                            com.trolmastercard.sexmod.f.b.a var10 = (com.trolmastercard.sexmod.f.b.a)((EntityType)com.trolmastercard.sexmod.i.b.q.get())
                                .create(var2);
                            if (var10 != null) {
                                var10.getEntityData().set(com.trolmastercard.sexmod.f.b.a.i, var6.getMainHandItem());
    ...
    Vec3 a(Player var1) {
        return var1.position().add(o.a(new Vec3(0.0, 0.0, 2.0), var1.yHeadRot));
    }
    ...
    public static void onRightClickItem(RightClickItem var0) {
        ...
        if (!com.trolmastercard.sexmod.f.c.a.b(var1)) {
            if (!var1.level().isClientSide()) {
                for (k var5 : k.ap()) {
                    if (!var5.isRemoved() && var5 instanceof com.trolmastercard.sexmod.f.b.a var6) {
                        ItemStack var7 = (ItemStack)var6.getEntityData().get(com.trolmastercard.sexmod.f.b.a.i);
                        if (var3.equals(var7)) {
                            return;
                        }
                    }
    ...
    public void registerControllers(ControllerRegistrar var1) {
        var1.add(new AnimationController(this, "controller", 2, a::a));
    }

    private static PlayState a(AnimationState<a> var0) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> var1) {
        var1.accept(new GeoRenderProvider() {
            private GeoItemRenderer<a> a;

            public GeoItemRenderer<?> a() {
                if (this.a == null) {
                    this.a = new com.trolmastercard.sexmod.b.b.c();
                }
