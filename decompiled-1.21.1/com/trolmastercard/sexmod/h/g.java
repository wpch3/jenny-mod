...
import com.trolmastercard.sexmod.l.j;
import com.trolmastercard.sexmod.l.k;
import com.trolmastercard.sexmod.l.r;
import com.trolmastercard.sexmod.l.s;
...
public class g extends Screen {
    ...
    public g(BlockPos var1, Direction var2) {
    ...
    public static void a(BlockPos var0, Direction var1) {
        ...
        var2.execute(() -> var2.setScreen(new g(var0, var1)));
    }
    ...
    private void a() {
        ...
        if (var1 != null) {
            ...
            if (!(var2.getBlock() instanceof BedBlock) && !(var2.getBlock() instanceof ChestBlock)) {
                boolean var3 = !com.trolmastercard.sexmod.b.a.a(this.b);
                com.trolmastercard.sexmod.b.a.a(this.b, var3);
                com.trolmastercard.sexmod.b.b.a(new s(this.b, var3));
                this.onClose();
            }
        }
    }
    ...
    private void b() {
        a = !a;
        com.trolmastercard.sexmod.b.b.a(new r(a));
        this.onClose();
    }
    ...
    private void c() {
        ...
        if (var1 != null) {
            ...
            if (var2.is(BlockTags.LOGS)) {
                ...
                com.trolmastercard.sexmod.b.a.a(this.b, var3);
                if (var3) {
                    com.trolmastercard.sexmod.b.b.a(new com.trolmastercard.sexmod.l.d(this.b));
                } else {
                    com.trolmastercard.sexmod.b.b.a(new j(this.b));
                }
            }

            BlockPos var5 = this.d();
            if (var5 != null) {
                boolean var4 = !com.trolmastercard.sexmod.b.a.a(var5);
                com.trolmastercard.sexmod.b.a.a(var5, var4);
                if (var4) {
                    com.trolmastercard.sexmod.b.b.a(new k(var5, this.c));
                } else {
                    com.trolmastercard.sexmod.b.b.a(new j(var5));
                }
            }
