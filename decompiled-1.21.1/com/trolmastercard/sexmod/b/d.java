...
public final class d {
    ...
    public static void onPlayerChangedDimension(PlayerChangedDimensionEvent var0) {
        ...
        if (var1.level() instanceof ServerLevel var2) {
            ...
            com.trolmastercard.sexmod.f.b.f var4 = null;

            for (com.trolmastercard.sexmod.f.b.k var6 : com.trolmastercard.sexmod.f.b.k.ap()) {
                if (!var6.level().isClientSide() && var6 instanceof com.trolmastercard.sexmod.f.b.f var7 && var8.equals(var7.g_())) {
                    var4 = var7;
                    break;
                }
            }
            ...
            if (var4 != null) {
                ...
                com.trolmastercard.sexmod.f.b.f var11 = (com.trolmastercard.sexmod.f.b.f)((EntityType)com.trolmastercard.sexmod.i.b.v.get()).create(var2);
                if (var11 == null) {
                    var4.discard();
                } else {
                    var11.b(var9);
                    ...
                    var11.a(var8);
                    var11.c(com.trolmastercard.sexmod.f.j.aO);
                    var4.discard();
                }
            }
        }
    ...
    public static void onLivingIncomingDamage(LivingIncomingDamageEvent var0) {
        ...
        if (!var1.is(DamageTypes.FELL_OUT_OF_WORLD)) {
            if (var0.getEntity() instanceof com.trolmastercard.sexmod.f.b.f var3) {
                if (var3.g_() != null) {
