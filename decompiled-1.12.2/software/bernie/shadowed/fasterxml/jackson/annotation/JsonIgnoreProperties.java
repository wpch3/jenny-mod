...
public @interface JsonIgnoreProperties {
    ...
    class Value implements JacksonAnnotationValue<JsonIgnoreProperties>, Serializable {
        ...
        public static JsonIgnoreProperties.Value construct(
            Set<String> ignored, boolean ignoreUnknown, boolean allowGetters, boolean allowSetters, boolean merge
        ) {
            return _empty(ignored, ignoreUnknown, allowGetters, allowSetters, merge)
                ? EMPTY
                : new JsonIgnoreProperties.Value(ignored, ignoreUnknown, allowGetters, allowSetters, merge);
        }
        ...
        public static JsonIgnoreProperties.Value mergeAll(JsonIgnoreProperties.Value... values) {
            ...
            for (JsonIgnoreProperties.Value curr : values) {
                if (curr != null) {
        ...
        public int hashCode() {
            return this._ignored.size()
                + (this._ignoreUnknown ? 1 : -3)
                + (this._allowGetters ? 3 : -7)
                + (this._allowSetters ? 7 : -11)
                + (this._merge ? 11 : -13);
        }
        ...
        public boolean equals(Object o) {
            if (o == this) {
                ...
                return o == null ? false : o.getClass() == this.getClass() && _equals(this, (JsonIgnoreProperties.Value)o);
            }
        }
        ...
        private static boolean _empty(Set<String> ignored, boolean ignoreUnknown, boolean allowGetters, boolean allowSetters, boolean merge) {
            return ignoreUnknown == EMPTY._ignoreUnknown && allowGetters == EMPTY._allowGetters && allowSetters == EMPTY._allowSetters && merge == EMPTY._merge
