...
public class POJOPropertyBuilder extends BeanPropertyDefinition implements Comparable<POJOPropertyBuilder> {
    ...
    public AnnotatedMethod getSetter() {
        ...
        throw new IllegalArgumentException(
            String.format("Conflicting setter definitions for property \"%s\": %s vs %s", this.getName(), curr.value.getFullName(), next.value.getFullName())
        );
    }
    ...
    public Iterator<AnnotatedParameter> getConstructorParameters() {
        return this._ctorParameters == null ? ClassUtil.emptyIterator() : new POJOPropertyBuilder.MemberIterator<>(this._ctorParameters);
    }
    ...
    protected Boolean _findRequired() {
        return this.fromMemberAnnotations(new POJOPropertyBuilder.WithMember<Boolean>() {
            public Boolean withMember(AnnotatedMember member) {
    ...
    protected String _findDescription() {
        return this.fromMemberAnnotations(new POJOPropertyBuilder.WithMember<String>() {
    ...
    protected Integer _findIndex() {
        return this.fromMemberAnnotations(new POJOPropertyBuilder.WithMember<Integer>() {
    ...
    public boolean anyIgnorals() {
        return this._anyIgnorals(this._fields)
            || this._anyIgnorals(this._getters)
            || this._anyIgnorals(this._setters)
            || this._anyIgnorals(this._ctorParameters);
    }
        ...
        for (POJOPropertyBuilder.Linked<?> node = accessors; node != null; node = node.next) {
            ...
            if (node.isNameExplicit && name != null) {
                ...
                if (firstAcc == this._fields) {
                    POJOPropertyBuilder.Linked<AnnotatedField> n2 = (POJOPropertyBuilder.Linked<AnnotatedField>)node;
                    prop._fields = n2.withNext(prop._fields);
                } else if (firstAcc == this._getters) {
                    POJOPropertyBuilder.Linked<AnnotatedMethod> n2 = (POJOPropertyBuilder.Linked<AnnotatedMethod>)node;
                    ...
                    POJOPropertyBuilder.Linked<AnnotatedParameter> n2 = (POJOPropertyBuilder.Linked<AnnotatedParameter>)node;
