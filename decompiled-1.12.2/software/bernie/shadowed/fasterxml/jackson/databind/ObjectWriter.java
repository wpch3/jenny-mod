...
public class ObjectWriter implements Versioned, Serializable {
    ...
    public static final class GeneratorSettings implements Serializable {
        ...
        public ObjectWriter.GeneratorSettings withRootValueSeparator(String sep) {
            if (sep == null) {
                return this.rootValueSeparator == null
                    ? this
                    : new ObjectWriter.GeneratorSettings(this.prettyPrinter, this.schema, this.characterEscapes, null);
            } else {
        ...
        public ObjectWriter.GeneratorSettings withRootValueSeparator(SerializableString sep) {
            if (sep == null) {
                ...
                return sep.equals(this.rootValueSeparator)
                    ? this
                    : new ObjectWriter.GeneratorSettings(this.prettyPrinter, this.schema, this.characterEscapes, sep);
            }
        }
    ...
    public static final class Prefetch implements Serializable {
        ...
        public ObjectWriter.Prefetch forRootType(ObjectWriter parent, JavaType newType) {
            ...
            if (noType) {
                return this.rootType != null && this.valueSerializer != null ? new ObjectWriter.Prefetch(null, null, this.typeSerializer) : this;
            }
