            ...
            if (key != DeserializationProblemHandler.NOT_HANDLED) {
                if (key != null && !targetClass.isInstance(key)) {
                    throw this.weirdNumberException(
                        ...
                        targetClass,
                        this._format(
                            "DeserializationProblemHandler.handleWeirdNumberValue() for type %s returned value of type %s", targetClass, key.getClass()
                        )
                    );
                }
            ...
            if (goodValue != DeserializationProblemHandler.NOT_HANDLED) {
                if (goodValue != null && !raw.isInstance(goodValue)) {
                    throw JsonMappingException.from(
                        p,
                        this._format(
                            "DeserializationProblemHandler.handleWeirdNativeValue() for type %s returned value of type %s", targetType, goodValue.getClass()
                        )
                    );
                }
