...
public abstract class AnimatedTickingGeoModel<T extends IAnimatable & IAnimationTickable> extends AnimatedGeoModel<T> {
    ...
    public void setLivingAnimations(T entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {
        ...
        if (manager.startTick == null) {
            manager.startTick = (double)(entity.tickTimer() + Minecraft.func_71410_x().func_184121_ak());
        }

        if (!Minecraft.func_71410_x().func_147113_T() || manager.shouldPlayWhilePaused) {
            manager.tick = entity.tickTimer() + Minecraft.func_71410_x().func_184121_ak();
        ...
        if (!this.getAnimationProcessor().getModelRendererList().isEmpty()) {
            this.getAnimationProcessor()
                .tickAnimation(entity, uniqueID, this.seekTime, predicate, GeckoLibCache.getInstance().parser, this.shouldCrashOnMissing);
        }
