...
public class bx extends Container {
    ...
    public ItemStack func_82846_b(EntityPlayer param1, int param2) {
        ...
        // 03: astore 3
        // 04: aload 0
        // 05: getfield com/trolmastercard/sexmod/bx.field_75151_b Ljava/util/List;
        // 08: iload 2
        ...
        // 1d: ifeq 9e
        // 20: goto 27
        // 23: invokestatic com/trolmastercard/sexmod/bx.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 26: athrow
        // 27: aload 4
        ...
        // 34: iload 2
        // 35: aload 0
        // 36: getfield com/trolmastercard/sexmod/bx.d I
        // 39: bipush 9
        // 3b: imul
        // 3c: if_icmpge 68
        // 3f: aload 0
        // 40: aload 5
        // 42: aload 0
        // 43: getfield com/trolmastercard/sexmod/bx.d I
        // 46: bipush 9
        // 48: imul
        // 49: aload 0
        // 4a: getfield com/trolmastercard/sexmod/bx.field_75151_b Ljava/util/List;
        // 4d: invokeinterface java/util/List.size ()I 1
        // 52: bipush 1
        // 53: invokevirtual com/trolmastercard/sexmod/bx.func_75135_a (Lnet/minecraft/item/ItemStack;IIZ)Z
        // 56: ifne 82
        // 59: goto 60
        // 5c: invokestatic com/trolmastercard/sexmod/bx.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 5f: athrow
        // 60: getstatic net/minecraft/item/ItemStack.field_190927_a Lnet/minecraft/item/ItemStack;
        // 63: areturn
        // 64: invokestatic com/trolmastercard/sexmod/bx.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 67: athrow
        // 68: aload 0
        // 69: aload 5
        // 6b: bipush 0
        // 6c: aload 0
        // 6d: getfield com/trolmastercard/sexmod/bx.d I
        // 70: bipush 9
        // 72: imul
        // 73: bipush 0
        // 74: invokevirtual com/trolmastercard/sexmod/bx.func_75135_a (Lnet/minecraft/item/ItemStack;IIZ)Z
        // 77: ifne 82
        // 7a: getstatic net/minecraft/item/ItemStack.field_190927_a Lnet/minecraft/item/ItemStack;
        // 7d: areturn
        // 7e: invokestatic com/trolmastercard/sexmod/bx.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 81: athrow
        // 82: aload 5
        ...
        // 92: goto 9e
        // 95: invokestatic com/trolmastercard/sexmod/bx.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 98: athrow
        // 99: aload 4
