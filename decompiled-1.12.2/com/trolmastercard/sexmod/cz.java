...
public class cz implements IMessage {
    ...
    public static class a implements IMessageHandler<cz, IMessage> {
        public IMessage a(cz param1, MessageContext param2) {
            ...
            // Bytecode:
            // 00: aload 1
            // 01: getfield com/trolmastercard/sexmod/cz.a Z
            // 04: ifeq 18
            // 07: aload 2
            ...
            // 0e: if_acmpeq 26
            // 11: goto 18
            // 14: invokestatic com/trolmastercard/sexmod/cz$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 17: athrow
            ...
            // 20: aconst_null
            // 21: areturn
            // 22: invokestatic com/trolmastercard/sexmod/cz$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 25: athrow
            ...
            // 2c: aload 1
            // 2d: invokedynamic run (Lcom/trolmastercard/sexmod/cz;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/trolmastercard/sexmod/cz$a.lambda$onMessage$0 (Lcom/trolmastercard/sexmod/cz;)V, ()V ]
