...
public class fe extends SlotItemHandler {
    ...
    public fe(fe.b var1, IItemHandler var2, int var3, int var4, int var5) {
    ...
    static boolean a(ItemStack param0, fe.b param1) {
        ...
        // 04: astore 2
        // 05: getstatic com/trolmastercard/sexmod/fe$a.a [I
        // 08: aload 1
        // 09: invokevirtual com/trolmastercard/sexmod/fe$b.ordinal ()I
        // 0c: iaload
        ...
        // 3c: ifne 54
        // 3f: goto 46
        // 42: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 45: athrow
        // 46: aload 2
        // 47: instanceof net/minecraft/item/ItemTool
        // 4a: ifeq 5c
        // 4d: goto 54
        // 50: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 53: athrow
        // 54: bipush 1
        // 55: goto 5d
        // 58: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 5b: athrow
        // 5c: bipush 0
        // 5d: ireturn
        // 5e: aload 2
        ...
        // 74: if_acmpne 86
        // 77: goto 7e
        // 7a: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 7d: athrow
        // 7e: bipush 1
        // 7f: goto 87
        // 82: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 85: athrow
        // 86: bipush 0
        // 87: ireturn
        // 88: aload 2
        ...
        // 99: if_acmpne ab
        // 9c: goto a3
        // 9f: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // a2: athrow
        // a3: bipush 1
        // a4: goto ac
        // a7: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // aa: athrow
        // ab: bipush 0
        // ac: ireturn
        // ad: aload 2
        ...
        // be: if_acmpne d0
        // c1: goto c8
        // c4: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // c7: athrow
        // c8: bipush 1
        // c9: goto d1
        // cc: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // cf: athrow
        // d0: bipush 0
        // d1: ireturn
        // d2: aload 2
        ...
        // e3: if_acmpne f5
        // e6: goto ed
        // e9: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // ec: athrow
        // ed: bipush 1
        // ee: goto f6
        // f1: invokestatic com/trolmastercard/sexmod/fe.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // f4: athrow
        // f5: bipush 0
        // f6: ireturn
        // f7: aload 2
