...
public class co extends Potion {
    ...
    public void a(LivingUpdateEvent param1) {
        ...
        // 11: astore 2
        // 12: aload 2
        // 13: getstatic com/trolmastercard/sexmod/co.b Lnet/minecraft/potion/Potion;
        ...
        // 20: bipush 2
        // 21: new com/trolmastercard/sexmod/cw
        // 24: dup
        // 25: aload 2
        // 26: invokespecial com/trolmastercard/sexmod/cw.<init> (Lnet/minecraft/entity/passive/EntityVillager;)V
        // 29: invokevirtual net/minecraft/entity/ai/EntityAITasks.func_75776_a (ILnet/minecraft/entity/ai/EntityAIBase;)V
        // 2c: aload 2
        // 2d: getstatic com/trolmastercard/sexmod/co.b Lnet/minecraft/potion/Potion;
        // 30: invokevirtual net/minecraft/entity/passive/EntityVillager.func_184589_d (Lnet/minecraft/potion/Potion;)V
        // 33: goto 3a
        // 36: invokestatic com/trolmastercard/sexmod/co.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 39: athrow
        // 3a: aload 1
        ...
        // 41: ifne 49
        // 44: return
        // 45: invokestatic com/trolmastercard/sexmod/co.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 48: athrow
        // 49: aload 1
        ...
        // 50: astore 2
        // 51: aload 2
        // 52: getstatic com/trolmastercard/sexmod/co.b Lnet/minecraft/potion/Potion;
        ...
        // 5f: iflt 88
        // 62: goto 69
        // 65: invokestatic com/trolmastercard/sexmod/co.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 68: athrow
        // 69: aload 2
        // 6a: bipush 0
        ...
        // 81: goto 88
        // 84: invokestatic com/trolmastercard/sexmod/co.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 87: athrow
        // 88: aload 2
        // 89: getstatic com/trolmastercard/sexmod/co.b Lnet/minecraft/potion/Potion;
