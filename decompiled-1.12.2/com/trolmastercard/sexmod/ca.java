...
public class ca extends Container {
    ...
    public ca(eb var1, InventoryPlayer var2, UUID var3) {
        ...
        if (var1.hasCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.NORTH)) {
            IItemHandler var4 = var1.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.NORTH);
            this.d = var1;
            this.b = new Slot[]{
                new fe(fe.b.WEAPON, var4, fe.b.WEAPON.id, 41, 60),
                new fe(fe.b.BOW, var4, fe.b.BOW.id, 59, 60),
                new fe(fe.b.HELMET, var4, fe.b.HELMET.id, 81, 60),
                new fe(fe.b.CHEST_PLATE, var4, fe.b.CHEST_PLATE.id, 100, 60),
                new fe(fe.b.PANTS, var4, fe.b.PANTS.id, 119, 60),
                new fe(fe.b.SHOES, var4, fe.b.SHOES.id, 138, 60),
                new fe(fe.b.ROD, var4, fe.b.ROD.id, 22, 60)
            };
    ...
    public ItemStack func_82846_b(EntityPlayer param1, int param2) {
        ...
        // 03: astore 3
        // 04: aload 0
        // 05: getfield com/trolmastercard/sexmod/ca.field_75151_b Ljava/util/List;
        // 08: iload 2
        ...
        // 1d: ifeq ae
        // 20: goto 27
        // 23: invokestatic com/trolmastercard/sexmod/ca.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 26: athrow
        // 27: aload 4
        ...
        // 33: astore 3
        // 34: aload 0
        // 35: getfield com/trolmastercard/sexmod/ca.field_75151_b Ljava/util/List;
        ...
        // 53: iload 6
        // 55: aload 0
        // 56: getfield com/trolmastercard/sexmod/ca.field_75151_b Ljava/util/List;
        // 59: invokeinterface java/util/List.size ()I 1
        // 5e: bipush 1
        // 5f: invokevirtual com/trolmastercard/sexmod/ca.func_75135_a (Lnet/minecraft/item/ItemStack;IIZ)Z
        // 62: ifne 89
        // 65: goto 6c
        // 68: invokestatic com/trolmastercard/sexmod/ca.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 6b: athrow
        // 6c: getstatic net/minecraft/item/ItemStack.field_190927_a Lnet/minecraft/item/ItemStack;
        // 6f: areturn
        // 70: invokestatic com/trolmastercard/sexmod/ca.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 73: athrow
        // 74: aload 0
        // 75: aload 5
        // 77: bipush 0
        // 78: iload 6
        // 7a: bipush 0
        // 7b: invokevirtual com/trolmastercard/sexmod/ca.func_75135_a (Lnet/minecraft/item/ItemStack;IIZ)Z
        // 7e: ifne 89
        // 81: getstatic net/minecraft/item/ItemStack.field_190927_a Lnet/minecraft/item/ItemStack;
        // 84: areturn
        // 85: invokestatic com/trolmastercard/sexmod/ca.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 88: athrow
        // 89: aload 5
        ...
        // 99: goto a5
        // 9c: invokestatic com/trolmastercard/sexmod/ca.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 9f: athrow
        // a0: aload 4
