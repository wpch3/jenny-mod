...
public class b_ implements IMessage {
    ...
    public static class a implements IMessageHandler<b_, IMessage> {
        public IMessage a(b_ param1, MessageContext param2) {
            ...
            // Bytecode:
            // 00: aload 1
            // 01: getfield com/trolmastercard/sexmod/b_.b Z
            // 04: ifeq 18
            // 07: aload 2
            ...
            // 0e: if_acmpeq 26
            // 11: goto 18
            // 14: invokestatic com/trolmastercard/sexmod/b_$a.a (Ljava/util/ConcurrentModificationException;)Ljava/util/ConcurrentModificationException;
            // 17: athrow
            ...
            // 20: aconst_null
            // 21: areturn
            // 22: invokestatic com/trolmastercard/sexmod/b_$a.a (Ljava/util/ConcurrentModificationException;)Ljava/util/ConcurrentModificationException;
            // 25: athrow
            ...
            // 2c: aload 2
            // 2d: aload 1
            // 2e: invokedynamic run (Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;Lcom/trolmastercard/sexmod/b_;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/trolmastercard/sexmod/b_$a.lambda$onMessage$0 (Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;Lcom/trolmastercard/sexmod/b_;)V, ()V ]
