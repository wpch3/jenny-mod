...
public class g9 implements IMessage {
    boolean c = false;
    UUID d;
    UUID a;
    String b;
    ...
    public g9(UUID var1, UUID var2, String var3) {
        this.d = var1;
        this.a = var2;
        this.b = var3;
    }
    ...
    public static class a implements IMessageHandler<g9, IMessage> {
        public IMessage a(g9 param1, MessageContext param2) {
            ...
            // Bytecode:
            // 00: aload 1
            // 01: getfield com/trolmastercard/sexmod/g9.c Z
            // 04: ifeq 18
            // 07: aload 2
            ...
            // 0e: if_acmpeq 26
            // 11: goto 18
            // 14: invokestatic com/trolmastercard/sexmod/g9$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 17: athrow
            ...
            // 20: aconst_null
            // 21: areturn
            // 22: invokestatic com/trolmastercard/sexmod/g9$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 25: athrow
            ...
            // 2c: aload 1
            // 2d: aload 2
            // 2e: invokedynamic run (Lcom/trolmastercard/sexmod/g9;Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/trolmastercard/sexmod/g9$a.lambda$onMessage$0 (Lcom/trolmastercard/sexmod/g9;Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)V, ()V ]
