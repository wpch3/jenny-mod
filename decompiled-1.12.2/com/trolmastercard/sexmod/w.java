...
public class w {
    ...
    public void a(@Nonnull w.a param1) {
        ...
        // 00a: aload 2
        // 00b: aload 1
        // 00c: getfield com/trolmastercard/sexmod/w$a.d Ljava/util/UUID;
        // 00f: invokevirtual net/minecraft/world/World.func_152378_a (Ljava/util/UUID;)Lnet/minecraft/entity/player/EntityPlayer;
        // 012: astore 3
        // 013: aload 2
        // 014: aload 1
        // 015: getfield com/trolmastercard/sexmod/w$a.c Ljava/util/UUID;
        ...
        // 023: ifnonnull 032
        // 026: goto 02d
        // 029: invokestatic com/trolmastercard/sexmod/w.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 02c: athrow
        // 02d: return
        // 02e: invokestatic com/trolmastercard/sexmod/w.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 031: athrow
        ...
        // 043: aload 1
        // 044: getfield com/trolmastercard/sexmod/w$a.b Z
        // 047: ifeq 056
        // 04a: aload 4
        // 04c: invokevirtual net/minecraft/entity/player/EntityPlayer.func_70005_c_ ()Ljava/lang/String;
        // 04f: goto 05a
        // 052: invokestatic com/trolmastercard/sexmod/w.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 055: athrow
        // 056: aload 3
        ...
        // 07f: aload 1
        // 080: getfield com/trolmastercard/sexmod/w$a.a Ljava/lang/String;
        // 083: bipush 0
        // 084: anewarray 14
        ...
        // 124: aload 0
        // 125: aload 1
        // 126: putfield com/trolmastercard/sexmod/w.b Lcom/trolmastercard/sexmod/w$a;
        // 129: return
