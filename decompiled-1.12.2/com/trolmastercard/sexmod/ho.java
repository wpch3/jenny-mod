...
public class ho extends EntityEnderPearl {
    ...
    protected void func_70184_a(RayTraceResult param1) {
        ...
        // Bytecode:
        // 000: aload 0
        // 001: invokevirtual com/trolmastercard/sexmod/ho.func_85052_h ()Lnet/minecraft/entity/EntityLivingBase;
        // 004: astore 2
        // 005: aload 1
        ...
        // 013: astore 3
        // 014: aload 0
        // 015: getfield com/trolmastercard/sexmod/ho.field_70170_p Lnet/minecraft/world/World;
        // 018: aload 3
        ...
        // 035: ifeq 058
        // 038: goto 03f
        // 03b: invokestatic com/trolmastercard/sexmod/ho.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 03e: athrow
        ...
        // 046: aload 0
        // 047: getfield com/trolmastercard/sexmod/ho.field_70170_p Lnet/minecraft/world/World;
        // 04a: aload 3
        ...
        // 051: goto 058
        // 054: invokestatic com/trolmastercard/sexmod/ho.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 057: athrow
        // 058: aload 5
        // 05a: aload 2
        // 05b: invokevirtual net/minecraft/tileentity/TileEntityEndGateway.func_184306_a (Lnet/minecraft/entity/Entity;)V
        // 05e: aload 0
        // 05f: invokevirtual com/trolmastercard/sexmod/ho.func_70106_y ()V
        // 062: return
        // 063: aload 5
        // 065: aload 0
        ...
        // 06f: if_icmpge 0b0
        // 072: aload 0
        // 073: getfield com/trolmastercard/sexmod/ho.field_70170_p Lnet/minecraft/world/World;
        // 076: getstatic net/minecraft/util/EnumParticleTypes.PORTAL Lnet/minecraft/util/EnumParticleTypes;
        // 079: aload 0
        // 07a: getfield com/trolmastercard/sexmod/ho.field_70165_t D
        // 07d: aload 0
        // 07e: getfield com/trolmastercard/sexmod/ho.field_70163_u D
        // 081: aload 0
        // 082: getfield com/trolmastercard/sexmod/ho.field_70146_Z Ljava/util/Random;
        // 085: invokevirtual java/util/Random.nextDouble ()D
        // 088: ldc2_w 2.0
        // 08b: dmul
        // 08c: dadd
        // 08d: aload 0
        // 08e: getfield com/trolmastercard/sexmod/ho.field_70161_v D
        // 091: aload 0
        // 092: getfield com/trolmastercard/sexmod/ho.field_70146_Z Ljava/util/Random;
        // 095: invokevirtual java/util/Random.nextGaussian ()D
        // 098: dconst_0
        // 099: aload 0
        // 09a: getfield com/trolmastercard/sexmod/ho.field_70146_Z Ljava/util/Random;
        ...
        // 0a6: iinc 3 1
        // 0a9: goto 06c
        // 0ac: invokestatic com/trolmastercard/sexmod/ho.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 0af: athrow
        // 0b0: aload 0
        // 0b1: getfield com/trolmastercard/sexmod/ho.field_70170_p Lnet/minecraft/world/World;
        // 0b4: getfield net/minecraft/world/World.field_72995_K Z
        // 0b7: ifne 131
        // 0ba: aload 2
        // 0bb: ifnull 12d
        // 0be: goto 0c5
        // 0c1: invokestatic com/trolmastercard/sexmod/ho.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 0c4: athrow
        // 0c5: aload 2
        // 0c6: checkcast com/trolmastercard/sexmod/em
        // 0c9: astore 3
        // 0ca: aload 3
        // 0cb: getfield com/trolmastercard/sexmod/em.l Lnet/minecraft/util/math/Vec3d;
        // 0ce: aload 0
        // 0cf: invokevirtual com/trolmastercard/sexmod/ho.func_174791_d ()Lnet/minecraft/util/math/Vec3d;
        ...
        // 0e0: aload 2
        // 0e1: aload 0
        // 0e2: getfield com/trolmastercard/sexmod/ho.field_70165_t D
        // 0e5: aload 0
        // 0e6: getfield com/trolmastercard/sexmod/ho.field_70163_u D
        // 0e9: aload 0
        // 0ea: getfield com/trolmastercard/sexmod/ho.field_70161_v D
        // 0ed: ldc 5.0
        ...
        // 103: ifeq 118
        // 106: goto 10d
        // 109: invokestatic com/trolmastercard/sexmod/ho.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 10c: athrow
        // 10d: aload 2
        // 10e: invokevirtual net/minecraft/entity/EntityLivingBase.func_184210_p ()V
        // 111: goto 118
        // 114: invokestatic com/trolmastercard/sexmod/ho.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 117: athrow
        // 118: aload 2
        // 119: aload 0
        // 11a: getfield com/trolmastercard/sexmod/ho.field_70165_t D
        // 11d: aload 0
        // 11e: getfield com/trolmastercard/sexmod/ho.field_70163_u D
        // 121: aload 0
        // 122: getfield com/trolmastercard/sexmod/ho.field_70161_v D
        ...
        // 12d: aload 0
        // 12e: invokevirtual com/trolmastercard/sexmod/ho.func_70106_y ()V
        // 131: return
