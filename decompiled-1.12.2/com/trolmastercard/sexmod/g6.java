...
public class g6 implements IMessage {
    boolean a = false;
    ...
    public g6(HashMap<String, Float> var1) {
        this.b = var1;
    }
    ...
    public static class a implements IMessageHandler<g6, IMessage> {
        public IMessage a(g6 param1, MessageContext param2) {
            ...
            // Bytecode:
            // 00: aload 1
            // 01: getfield com/trolmastercard/sexmod/g6.a Z
            // 04: ifne 15
            ...
            // 0f: aconst_null
            // 10: areturn
            // 11: invokestatic com/trolmastercard/sexmod/g6$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 14: athrow
            // 15: aload 2
            ...
            // 1c: ifeq bc
            // 1f: invokestatic com/trolmastercard/sexmod/br.b ()Z
            // 22: ifne 32
            // 25: goto 2c
            // 28: invokestatic com/trolmastercard/sexmod/g6$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 2b: athrow
            // 2c: aconst_null
            // 2d: areturn
            // 2e: invokestatic com/trolmastercard/sexmod/g6$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 31: athrow
            ...
            // 39: astore 3
            // 3a: aload 1
            // 3b: getfield com/trolmastercard/sexmod/g6.b Ljava/util/HashMap;
            ...
            // 68: astore 6
            // 6a: aload 6
            // 6c: invokestatic com/trolmastercard/sexmod/br.f (Ljava/lang/String;)Z
            // 6f: ifne 82
            // 72: aload 3
            // 73: aload 6
            ...
            // 7a: pop
            // 7b: goto 48
            // 7e: invokestatic com/trolmastercard/sexmod/g6$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // 81: athrow
            // 82: aload 6
            // 84: invokestatic com/trolmastercard/sexmod/br.i (Ljava/lang/String;)F
            // 87: fstore 7
            // 89: aload 5
            ...
            // a8: pop
            // a9: goto b0
            // ac: invokestatic com/trolmastercard/sexmod/g6$a.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
            // af: athrow
            // b0: goto 48
            // b3: new com/trolmastercard/sexmod/cu
            // b6: dup
            // b7: aload 3
            // b8: invokespecial com/trolmastercard/sexmod/cu.<init> (Ljava/util/List;)V
            // bb: areturn
            ...
            // c2: aload 2
            // c3: invokedynamic run (Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/trolmastercard/sexmod/g6$a.lambda$onMessage$0 (Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)V, ()V ]
