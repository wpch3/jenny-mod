...
public class bs {
    ...
    public bs(BlockPos var1, bs.a var2, HashSet<BlockPos> var3) {
        this.a = var1;
        this.c = var2;
        this.b = var3;
    }

    public bs(BlockPos var1, bs.a var2, HashSet<BlockPos> var3, EnumFacing var4) {
        this.a = var1;
        this.c = var2;
        this.b = var3;
        this.e = var4;
    ...
    public static HashSet<BlockPos> a(World param0, BlockPos param1, UUID param2) {
        ...
        // 002: aload 0
        // 003: aload 3
        // 004: invokestatic com/trolmastercard/sexmod/bs.c (Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;)Z
        // 007: ifne 012
        // 00a: aload 1
        ...
        // 015: aload 0
        // 016: aload 4
        // 018: invokestatic com/trolmastercard/sexmod/bs.b (Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;)Z
        // 01b: ifne 028
        // 01e: aload 4
        ...
        // 055: iinc 7 1
        // 058: goto 040
        // 05b: invokestatic com/trolmastercard/sexmod/bs.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 05e: athrow
        // 05f: aload 0
        // 060: aload 3
        // 061: invokestatic com/trolmastercard/sexmod/bs.a (Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;)Ljava/util/HashSet;
        // 064: astore 7
        ...
        // 0a1: if_icmpne 0ba
        // 0a4: goto 0ab
        // 0a7: invokestatic com/trolmastercard/sexmod/bs.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 0aa: athrow
        // 0ab: aload 8
        // 0ad: aload 10
        ...
        // 0b2: pop
        // 0b3: goto 0ba
        // 0b6: invokestatic com/trolmastercard/sexmod/bs.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 0b9: athrow
        // 0ba: goto 076
        // 0bd: aload 8
        ...
        // 111: astore 11
        // 113: aload 2
        // 114: invokestatic com/trolmastercard/sexmod/ax.p (Ljava/util/UUID;)Ljava/util/Collection;
        ...
        // 12f: checkcast com/trolmastercard/sexmod/bs
        // 132: astore 13
        // 134: aload 13
        // 136: invokevirtual com/trolmastercard/sexmod/bs.g ()Ljava/util/HashSet;
        // 139: astore 14
        // 13b: aload 14
        // 13d: aload 11
        ...
        // 14c: pop
        // 14d: goto 157
        // 150: invokestatic com/trolmastercard/sexmod/bs.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 153: athrow
        // 154: goto 11e
        // 157: goto 0fd
        // 15a: aload 5
        ...
        // 161: pop
        // 162: new com/trolmastercard/sexmod/bs
        // 165: dup
        // 166: aload 3
        // 167: getstatic com/trolmastercard/sexmod/bs$a.FALL_TREE Lcom/trolmastercard/sexmod/bs$a;
        // 16a: aload 5
        // 16c: invokespecial com/trolmastercard/sexmod/bs.<init> (Lnet/minecraft/util/math/BlockPos;Lcom/trolmastercard/sexmod/bs$a;Ljava/util/HashSet;)V
        // 16f: astore 10
        // 171: aload 2
        // 172: aload 10
        // 174: invokestatic com/trolmastercard/sexmod/ax.b (Ljava/util/UUID;Lcom/trolmastercard/sexmod/bs;)V
        // 177: aload 5
        // 179: areturn
    ...
    static boolean c(World param0, BlockPos param1) {
        ...
        // 19: if_acmpeq 2b
        // 1c: goto 23
        // 1f: invokestatic com/trolmastercard/sexmod/bs.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 22: athrow
        // 23: bipush 1
        // 24: goto 2c
        // 27: invokestatic com/trolmastercard/sexmod/bs.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 2a: athrow
        // 2b: bipush 0
        // 2c: ireturn
