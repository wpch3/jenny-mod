...
public class fi extends Render<gi> {
    ...
    public void a(gi param1, double param2, double param4, double param6, float param8, float param9) {
        ...
        // Bytecode:
        // 000: aload 1
        // 001: invokevirtual com/trolmastercard/sexmod/gi.g ()Lcom/trolmastercard/sexmod/eb;
        // 004: astore 10
        // 006: aload 10
        // 008: ifnull 02a
        // 00b: aload 0
        // 00c: getfield com/trolmastercard/sexmod/fi.field_188301_f Z
        // 00f: ifne 02a
        // 012: goto 019
        // 015: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 018: athrow
        // 019: aload 10
        // 01b: getfield com/trolmastercard/sexmod/eb.Z F
        // 01e: fconst_1
        // 01f: fcmpl
        // 020: ifne 02f
        // 023: goto 02a
        // 026: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 029: athrow
        // 02a: return
        // 02b: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 02e: athrow
        // 02f: aload 10
        // 031: aload 1
        // 032: putfield com/trolmastercard/sexmod/eb.av Lcom/trolmastercard/sexmod/gi;
        // 035: aload 10
        // 037: invokevirtual com/trolmastercard/sexmod/eb.func_184212_Q ()Lnet/minecraft/network/datasync/EntityDataManager;
        // 03a: getstatic com/trolmastercard/sexmod/eb.ag Lnet/minecraft/network/datasync/DataParameter;
        ...
        // 064: aload 10
        // 066: dup
        // 067: getfield com/trolmastercard/sexmod/eb.Z F
        // 06a: ldc 60.0
        // 06c: fload 12
        // 06e: fdiv
        // 06f: ldc 0.01666
        ...
        // 073: fmul
        // 074: fadd
        // 075: putfield com/trolmastercard/sexmod/eb.Z F
        // 078: aload 10
        // 07a: fconst_1
        // 07b: aload 10
        // 07d: getfield com/trolmastercard/sexmod/eb.Z F
        // 080: invokestatic java/lang/Math.min (FF)F
        // 083: putfield com/trolmastercard/sexmod/eb.Z F
        ...
        // 0a9: fload 9
        // 0ab: f2d
        // 0ac: invokestatic com/trolmastercard/sexmod/b6.a (Lnet/minecraft/util/math/Vec3d;Lnet/minecraft/util/math/Vec3d;D)Lnet/minecraft/util/math/Vec3d;
        // 0af: astore 14
        ...
        // 0c2: dup
        // 0c3: aload 10
        // 0c5: getfield com/trolmastercard/sexmod/eb.field_70142_S D
        // 0c8: aload 10
        // 0ca: getfield com/trolmastercard/sexmod/eb.field_70137_T D
        // 0cd: ldc2_w 0.875
        // 0d0: dadd
        // 0d1: aload 10
        // 0d3: getfield com/trolmastercard/sexmod/eb.field_70136_U D
        // 0d6: invokespecial net/minecraft/util/math/Vec3d.<init> (DDD)V
        // 0d9: aload 10
        // 0db: invokevirtual com/trolmastercard/sexmod/eb.func_174791_d ()Lnet/minecraft/util/math/Vec3d;
        // 0de: dconst_0
        // 0df: ldc2_w 0.875
        // 0e2: dconst_0
        ...
        // 0e6: fload 9
        // 0e8: f2d
        // 0e9: invokestatic com/trolmastercard/sexmod/b6.a (Lnet/minecraft/util/math/Vec3d;Lnet/minecraft/util/math/Vec3d;D)Lnet/minecraft/util/math/Vec3d;
        // 0ec: astore 16
        // 0ee: aload 16
        // 0f0: aload 14
        ...
        // 0f9: aload 16
        // 0fb: aload 10
        // 0fd: getfield com/trolmastercard/sexmod/eb.Z F
        // 100: f2d
        // 101: invokestatic com/trolmastercard/sexmod/b6.a (Lnet/minecraft/util/math/Vec3d;Lnet/minecraft/util/math/Vec3d;D)Lnet/minecraft/util/math/Vec3d;
        // 104: astore 15
        // 106: aload 15
        ...
        // 11d: aload 10
        // 11f: fconst_0
        // 120: putfield com/trolmastercard/sexmod/eb.Z F
        ...
        // 13d: aload 0
        // 13e: aload 1
        // 13f: invokevirtual com/trolmastercard/sexmod/fi.func_180548_c (Lnet/minecraft/entity/Entity;)Z
        // 142: pop
        ...
        // 14f: ldc 180.0
        // 151: aload 0
        // 152: getfield com/trolmastercard/sexmod/fi.field_76990_c Lnet/minecraft/client/renderer/entity/RenderManager;
        ...
        // 15f: aload 0
        // 160: getfield com/trolmastercard/sexmod/fi.field_76990_c Lnet/minecraft/client/renderer/entity/RenderManager;
        ...
        // 16d: bipush -1
        // 16e: goto 176
        // 171: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 174: athrow
        // 175: bipush 1
        // 176: i2f
        // 177: aload 0
        // 178: getfield com/trolmastercard/sexmod/fi.field_76990_c Lnet/minecraft/client/renderer/entity/RenderManager;
        ...
        // 186: aload 0
        // 187: getfield com/trolmastercard/sexmod/fi.field_188301_f Z
        // 18a: ifeq 19f
        // 18d: invokestatic net/minecraft/client/renderer/GlStateManager.func_179142_g ()V
        // 190: aload 0
        // 191: aload 1
        // 192: invokevirtual com/trolmastercard/sexmod/fi.func_188298_c (Lnet/minecraft/entity/Entity;)I
        // 195: invokestatic net/minecraft/client/renderer/GlStateManager.func_187431_e (I)V
        // 198: goto 19f
        // 19b: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 19e: athrow
        // 19f: aload 11
        ...
        // 1da: goto 1e1
        // 1dd: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 1e0: athrow
        // 1e1: aload 0
        // 1e2: aload 1
        // 1e3: invokevirtual com/trolmastercard/sexmod/fi.func_180548_c (Lnet/minecraft/entity/Entity;)Z
        // 1e6: pop
        // 1e7: aload 13
        // 1e9: bipush 7
        ...
        // 26e: aload 0
        // 26f: getfield com/trolmastercard/sexmod/fi.field_188301_f Z
        // 272: ifeq 282
        ...
        // 27b: goto 282
        // 27e: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 281: athrow
        ...
        // 288: aload 10
        // 28a: invokevirtual com/trolmastercard/sexmod/eb.func_184591_cq ()Lnet/minecraft/util/EnumHandSide;
        // 28d: getstatic net/minecraft/util/EnumHandSide.RIGHT Lnet/minecraft/util/EnumHandSide;
        // 290: if_acmpne 29b
        // 293: bipush 1
        // 294: goto 29c
        // 297: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 29a: athrow
        // 29b: bipush -1
        // 29c: istore 14
        // 29e: aload 10
        // 2a0: invokevirtual com/trolmastercard/sexmod/eb.func_184614_ca ()Lnet/minecraft/item/ItemStack;
        // 2a3: astore 15
        // 2a5: aload 15
        ...
        // 2b5: aload 10
        // 2b7: aload 10
        // 2b9: invokevirtual com/trolmastercard/sexmod/eb.I ()Ljava/lang/Float;
        // 2bc: invokevirtual java/lang/Float.floatValue ()F
        // 2bf: putfield com/trolmastercard/sexmod/eb.field_70177_z F
        // 2c2: aload 10
        // 2c4: aload 10
        // 2c6: invokevirtual com/trolmastercard/sexmod/eb.I ()Ljava/lang/Float;
        // 2c9: invokevirtual java/lang/Float.floatValue ()F
        // 2cc: putfield com/trolmastercard/sexmod/eb.field_70761_aq F
        // 2cf: aload 10
        // 2d1: aload 10
        // 2d3: invokevirtual com/trolmastercard/sexmod/eb.o ()Lnet/minecraft/util/math/Vec3d;
        // 2d6: getfield net/minecraft/util/math/Vec3d.field_72450_a D
        // 2d9: putfield com/trolmastercard/sexmod/eb.field_70165_t D
        // 2dc: aload 10
        // 2de: aload 10
        // 2e0: invokevirtual com/trolmastercard/sexmod/eb.o ()Lnet/minecraft/util/math/Vec3d;
        // 2e3: getfield net/minecraft/util/math/Vec3d.field_72448_b D
        // 2e6: putfield com/trolmastercard/sexmod/eb.field_70163_u D
        // 2e9: aload 10
        // 2eb: aload 10
        // 2ed: invokevirtual com/trolmastercard/sexmod/eb.o ()Lnet/minecraft/util/math/Vec3d;
        // 2f0: getfield net/minecraft/util/math/Vec3d.field_72449_c D
        // 2f3: putfield com/trolmastercard/sexmod/eb.field_70161_v D
        // 2f6: aload 10
        // 2f8: aload 10
        // 2fa: invokevirtual com/trolmastercard/sexmod/eb.o ()Lnet/minecraft/util/math/Vec3d;
        // 2fd: getfield net/minecraft/util/math/Vec3d.field_72450_a D
        // 300: putfield com/trolmastercard/sexmod/eb.field_70169_q D
        // 303: aload 10
        // 305: aload 10
        // 307: invokevirtual com/trolmastercard/sexmod/eb.o ()Lnet/minecraft/util/math/Vec3d;
        // 30a: getfield net/minecraft/util/math/Vec3d.field_72448_b D
        // 30d: putfield com/trolmastercard/sexmod/eb.field_70167_r D
        // 310: aload 10
        // 312: aload 10
        // 314: invokevirtual com/trolmastercard/sexmod/eb.o ()Lnet/minecraft/util/math/Vec3d;
        // 317: getfield net/minecraft/util/math/Vec3d.field_72449_c D
        // 31a: putfield com/trolmastercard/sexmod/eb.field_70166_s D
        // 31d: aload 10
        // 31f: getfield com/trolmastercard/sexmod/eb.field_70760_ar F
        // 322: aload 10
        // 324: getfield com/trolmastercard/sexmod/eb.field_70761_aq F
        // 327: aload 10
        // 329: getfield com/trolmastercard/sexmod/eb.field_70760_ar F
        // 32c: fsub
        // 32d: fload 9
        // 32f: fmul
        // 330: fadd
        ...
        // 34d: dstore 21
        // 34f: aload 10
        // 351: getfield com/trolmastercard/sexmod/eb.field_70169_q D
        // 354: aload 10
        // 356: getfield com/trolmastercard/sexmod/eb.field_70165_t D
        // 359: aload 10
        // 35b: getfield com/trolmastercard/sexmod/eb.field_70169_q D
        // 35e: dsub
        // 35f: fload 9
        // 361: f2d
        // 362: dmul
        ...
        // 371: dstore 23
        // 373: aload 10
        // 375: getfield com/trolmastercard/sexmod/eb.field_70167_r D
        // 378: aload 10
        // 37a: invokevirtual com/trolmastercard/sexmod/eb.func_70047_e ()F
        // 37d: f2d
        // 37e: dadd
        // 37f: aload 10
        // 381: getfield com/trolmastercard/sexmod/eb.field_70163_u D
        // 384: aload 10
        // 386: getfield com/trolmastercard/sexmod/eb.field_70167_r D
        // 389: dsub
        // 38a: fload 9
        // 38c: f2d
        // 38d: dmul
        ...
        // 393: dstore 25
        // 395: aload 10
        // 397: getfield com/trolmastercard/sexmod/eb.field_70166_s D
        // 39a: aload 10
        // 39c: getfield com/trolmastercard/sexmod/eb.field_70161_v D
        // 39f: aload 10
        // 3a1: getfield com/trolmastercard/sexmod/eb.field_70166_s D
        // 3a4: dsub
        // 3a5: fload 9
        // 3a7: f2d
        // 3a8: dmul
        ...
        // 3b7: dstore 27
        // 3b9: aload 10
        // 3bb: invokevirtual com/trolmastercard/sexmod/eb.func_70093_af ()Z
        // 3be: ifeq 3cb
        // 3c1: ldc2_w -0.1875
        // 3c4: goto 3cc
        // 3c7: invokestatic com/trolmastercard/sexmod/fi.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 3ca: athrow
        // 3cb: dconst_0
        // 3cc: dstore 29
        // 3ce: aload 1
        // 3cf: getfield com/trolmastercard/sexmod/gi.field_70169_q D
        // 3d2: aload 1
        // 3d3: getfield com/trolmastercard/sexmod/gi.field_70165_t D
        // 3d6: aload 1
        // 3d7: getfield com/trolmastercard/sexmod/gi.field_70169_q D
        // 3da: dsub
        // 3db: fload 9
        // 3dd: f2d
        // 3de: dmul
        // 3df: dadd
        // 3e0: aload 10
        // 3e2: invokevirtual com/trolmastercard/sexmod/eb.I ()Ljava/lang/Float;
        ...
        // 3f7: dsub
        // 3f8: aload 10
        // 3fa: invokevirtual com/trolmastercard/sexmod/eb.I ()Ljava/lang/Float;
        ...
        // 40d: dstore 31
        // 40f: aload 1
        // 410: getfield com/trolmastercard/sexmod/gi.field_70167_r D
        // 413: aload 1
        // 414: getfield com/trolmastercard/sexmod/gi.field_70163_u D
        // 417: aload 1
        // 418: getfield com/trolmastercard/sexmod/gi.field_70167_r D
        // 41b: dsub
        // 41c: fload 9
        // 41e: f2d
        // 41f: dmul
        ...
        // 429: dstore 33
        // 42b: aload 1
        // 42c: getfield com/trolmastercard/sexmod/gi.field_70166_s D
        // 42f: aload 1
        // 430: getfield com/trolmastercard/sexmod/gi.field_70161_v D
        // 433: aload 1
        // 434: getfield com/trolmastercard/sexmod/gi.field_70166_s D
        // 437: dsub
        // 438: fload 9
        // 43a: f2d
        // 43b: dmul
        // 43c: dadd
        // 43d: aload 10
        // 43f: invokevirtual com/trolmastercard/sexmod/eb.I ()Ljava/lang/Float;
        ...
        // 454: dadd
        // 455: aload 10
        // 457: invokevirtual com/trolmastercard/sexmod/eb.I ()Ljava/lang/Float;
