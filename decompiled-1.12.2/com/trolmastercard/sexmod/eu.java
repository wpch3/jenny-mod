...
public class eu implements IMessage {
    boolean c;
    UUID a;
    UUID b;
    String d;
    ...
    public eu(UUID var1, UUID var2, String var3) {
        this.a = var1;
        this.b = var2;
        this.d = var3;
    }
    ...
    public static class a implements IMessageHandler<eu, IMessage> {
        public IMessage a(eu param1, MessageContext param2) {
            ...
            // Bytecode:
            // 00: aload 1
            // 01: getfield com/trolmastercard/sexmod/eu.c Z
            // 04: ifeq 18
            // 07: aload 2
            ...
            // 0e: if_acmpeq 26
            // 11: goto 18
            // 14: invokestatic com/trolmastercard/sexmod/eu$a.a (Ljava/lang/Exception;)Ljava/lang/Exception;
            // 17: athrow
            // 18: getstatic java/lang/System.out Ljava/io/PrintStream;
            // 1b: ldc "received an invalid message @StartStandingSexAnimation :("
            // 1d: invokevirtual java/io/PrintStream.println (Ljava/lang/String;)V
            // 20: aconst_null
            // 21: areturn
            // 22: invokestatic com/trolmastercard/sexmod/eu$a.a (Ljava/lang/Exception;)Ljava/lang/Exception;
            // 25: athrow
            ...
            // 2c: aload 1
            // 2d: invokedynamic run (Lcom/trolmastercard/sexmod/eu;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/trolmastercard/sexmod/eu$a.lambda$onMessage$0 (Lcom/trolmastercard/sexmod/eu;)V, ()V ]
