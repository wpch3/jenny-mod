...
public class fu {
    ...
    public void a(RightClickBlock var1) {
        ...
        var2.c(new Vec3d(var7.func_177958_n() + 0.5, var7.func_177956_o() + 0.0F, var7.func_177952_p() + 0.5));
    ...
    public void b(RightClickBlock param1) {
        ...
        // 004: astore 2
        // 005: aload 2
        // 006: invokestatic com/trolmastercard/sexmod/ei.g (Lnet/minecraft/entity/player/EntityPlayer;)Lcom/trolmastercard/sexmod/ei;
        // 009: astore 3
        // 00a: aload 3
        // 00b: ifnonnull 013
        // 00e: return
        // 00f: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 012: athrow
        // 013: aload 3
        // 014: instanceof com/trolmastercard/sexmod/ec
        // 017: ifne 01f
        // 01a: return
        // 01b: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 01e: athrow
        // 01f: aload 2
        // 020: invokevirtual net/minecraft/entity/player/EntityPlayer.func_70093_af ()Z
        // 023: ifne 02b
        // 026: return
        // 027: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 02a: athrow
        // 02b: aload 2
        ...
        // 035: ifne 03d
        // 038: return
        // 039: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 03c: athrow
        // 03d: aload 3
        // 03e: invokevirtual com/trolmastercard/sexmod/ei.func_184212_Q ()Lnet/minecraft/network/datasync/EntityDataManager;
        // 041: getstatic com/trolmastercard/sexmod/em.G Lnet/minecraft/network/datasync/DataParameter;
        ...
        // 04d: ifeq 055
        // 050: return
        // 051: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 054: athrow
        // 055: aload 2
        ...
        // 05c: ifge 064
        // 05f: return
        // 060: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 063: athrow
        // 064: aload 1
        ...
        // 06c: ifnonnull 074
        // 06f: return
        // 070: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 073: athrow
        ...
        // 09e: ifle 0a6
        // 0a1: return
        // 0a2: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 0a5: athrow
        // 0a6: aload 2
        // 0a7: aload 5
        ...
        // 0bc: aload 3
        // 0bd: aload 5
        // 0bf: invokevirtual com/trolmastercard/sexmod/ei.c (Lnet/minecraft/util/math/Vec3d;)V
        // 0c2: aload 3
        // 0c3: aload 2
        // 0c4: getfield net/minecraft/entity/player/EntityPlayer.field_70177_z F
        // 0c7: invokevirtual com/trolmastercard/sexmod/ei.b (F)V
        // 0ca: aload 3
        // 0cb: invokevirtual com/trolmastercard/sexmod/ei.func_184212_Q ()Lnet/minecraft/network/datasync/EntityDataManager;
        // 0ce: getstatic com/trolmastercard/sexmod/em.G Lnet/minecraft/network/datasync/DataParameter;
        // 0d1: bipush 1
        ...
        // 0d8: aload 3
        // 0d9: invokevirtual com/trolmastercard/sexmod/ei.func_184212_Q ()Lnet/minecraft/network/datasync/EntityDataManager;
        // 0dc: getstatic com/trolmastercard/sexmod/em.D Lnet/minecraft/network/datasync/DataParameter;
        // 0df: bipush 0
        ...
        // 0e6: aload 3
        // 0e7: getstatic com/trolmastercard/sexmod/fp.STARTDOGGY Lcom/trolmastercard/sexmod/fp;
        // 0ea: invokevirtual com/trolmastercard/sexmod/ei.b (Lcom/trolmastercard/sexmod/fp;)V
        // 0ed: aload 1
        ...
        // 107: ifeq 11c
        // 10a: goto 111
        // 10d: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 110: athrow
        // 111: bipush 0
        // 112: invokestatic com/trolmastercard/sexmod/d3.a (Z)V
        // 115: goto 11c
        // 118: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 11b: athrow
        // 11c: return
    ...
    public void a(LivingHurtEvent param1) {
        ...
        // 07: ifne 0f
        // 0a: return
        // 0b: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 0e: athrow
        // 0f: aload 1
        ...
        // 16: if_acmpeq 1e
        // 19: return
        // 1a: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 1d: athrow
        // 1e: aload 1
        ...
        // 25: astore 2
        // 26: aload 2
        // 27: invokestatic com/trolmastercard/sexmod/ei.g (Lnet/minecraft/entity/player/EntityPlayer;)Lcom/trolmastercard/sexmod/ei;
        // 2a: astore 3
        // 2b: aload 3
        // 2c: ifnonnull 34
        // 2f: return
        // 30: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 33: athrow
        // 34: aload 3
        // 35: instanceof com/trolmastercard/sexmod/e5
        // 38: ifne 49
        // 3b: aload 3
        // 3c: instanceof com/trolmastercard/sexmod/e9
        // 3f: ifeq 55
        // 42: goto 49
        // 45: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 48: athrow
        // 49: aload 1
        // 4a: bipush 1
        // 4b: invokevirtual net/minecraftforge/event/entity/living/LivingHurtEvent.setCanceled (Z)V
        // 4e: goto 55
        // 51: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 54: athrow
        // 55: return
    ...
    public void a(InitGuiEvent param1) {
        ...
        // 10: ifne 1f
        // 13: goto 1a
        // 16: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 19: athrow
        // 1a: return
        // 1b: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 1e: athrow
        ...
        // 27: ifnonnull 2f
        // 2a: return
        // 2b: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 2e: athrow
        // 2f: aload 3
        // 30: invokestatic com/trolmastercard/sexmod/ei.g (Lnet/minecraft/entity/player/EntityPlayer;)Lcom/trolmastercard/sexmod/ei;
        // 33: astore 4
        // 35: aload 4
        // 37: ifnonnull 3f
        // 3a: return
        // 3b: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 3e: athrow
        // 3f: aload 4
        // 41: invokevirtual com/trolmastercard/sexmod/ei.A ()Z
        // 44: ifeq 4c
        // 47: return
        // 48: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 4b: athrow
        // 4c: aload 1
        // 4d: invokevirtual net/minecraftforge/client/event/GuiScreenEvent$InitGuiEvent.getButtonList ()Ljava/util/List;
        // 50: astore 5
        // 52: aload 4
        // 54: invokevirtual com/trolmastercard/sexmod/ei.ah ()I
        // 57: ifne 63
        // 5a: ldc "action.names.dressup"
        // 5c: goto 65
        // 5f: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 62: athrow
    ...
    public void a(ActionPerformedEvent param1) {
        ...
        // 28: if_icmpeq 30
        // 2b: return
        // 2c: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 2f: athrow
        ...
        // 3b: invokestatic com/trolmastercard/sexmod/ei.d (Ljava/util/UUID;)Lcom/trolmastercard/sexmod/ei;
        // 3e: astore 4
        // 40: aload 4
        // 42: ifnonnull 4a
        // 45: return
        // 46: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 49: athrow
        // 4a: aload 4
        // 4c: invokevirtual com/trolmastercard/sexmod/ei.A ()Z
        // 4f: ifeq 57
        // 52: return
        // 53: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 56: athrow
        // 57: aload 4
        // 59: invokevirtual com/trolmastercard/sexmod/ei.ae ()Ljava/util/UUID;
        // 5c: ifnull 64
        // 5f: return
        // 60: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 63: athrow
        // 64: aload 4
        // 66: invokevirtual com/trolmastercard/sexmod/ei.y ()Lcom/trolmastercard/sexmod/fp;
        // 69: getstatic com/trolmastercard/sexmod/fp.NULL Lcom/trolmastercard/sexmod/fp;
        // 6c: if_acmpeq 74
        // 6f: return
        // 70: invokestatic com/trolmastercard/sexmod/fu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 73: athrow
        // 74: aload 3
        ...
        // 84: aload 4
        // 86: getstatic com/trolmastercard/sexmod/fp.STRIP Lcom/trolmastercard/sexmod/fp;
        // 89: invokevirtual com/trolmastercard/sexmod/ei.b (Lcom/trolmastercard/sexmod/fp;)V
        // 8c: bipush 0
        // 8d: invokestatic com/trolmastercard/sexmod/d3.a (Z)V
        // 90: aload 3
