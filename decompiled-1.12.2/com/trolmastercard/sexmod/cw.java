...
public class cw extends EntityAIBase {
    ...
    private void a() {
        ...
        // Bytecode:
        // 00: aload 0
        // 01: getfield com/trolmastercard/sexmod/cw.c Lnet/minecraft/entity/passive/EntityVillager;
        // 04: aload 0
        // 05: getfield com/trolmastercard/sexmod/cw.d Lnet/minecraft/entity/passive/EntityVillager;
        ...
        // 0b: astore 1
        // 0c: aload 0
        // 0d: getfield com/trolmastercard/sexmod/cw.d Lnet/minecraft/entity/passive/EntityVillager;
        // 10: sipush 6000
        // 13: invokevirtual net/minecraft/entity/passive/EntityVillager.func_70873_a (I)V
        // 16: aload 0
        // 17: getfield com/trolmastercard/sexmod/cw.c Lnet/minecraft/entity/passive/EntityVillager;
        // 1a: sipush 6000
        // 1d: invokevirtual net/minecraft/entity/passive/EntityVillager.func_70873_a (I)V
        // 20: aload 0
        // 21: getfield com/trolmastercard/sexmod/cw.d Lnet/minecraft/entity/passive/EntityVillager;
        // 24: bipush 0
        // 25: invokevirtual net/minecraft/entity/passive/EntityVillager.func_175549_o (Z)V
        // 28: aload 0
        // 29: getfield com/trolmastercard/sexmod/cw.c Lnet/minecraft/entity/passive/EntityVillager;
        // 2c: bipush 0
        ...
        // 33: dup
        // 34: aload 0
        // 35: getfield com/trolmastercard/sexmod/cw.c Lnet/minecraft/entity/passive/EntityVillager;
        // 38: aload 0
        // 39: getfield com/trolmastercard/sexmod/cw.d Lnet/minecraft/entity/passive/EntityVillager;
        // 3c: aload 1
        ...
        // 4f: ifnonnull 5e
        // 52: goto 59
        // 55: invokestatic com/trolmastercard/sexmod/cw.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 58: athrow
        // 59: return
        // 5a: invokestatic com/trolmastercard/sexmod/cw.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 5d: athrow
        // 5e: aload 2
        ...
        // 6a: aload 1
        // 6b: aload 0
        // 6c: getfield com/trolmastercard/sexmod/cw.c Lnet/minecraft/entity/passive/EntityVillager;
        // 6f: getfield net/minecraft/entity/passive/EntityVillager.field_70165_t D
        // 72: aload 0
        // 73: getfield com/trolmastercard/sexmod/cw.c Lnet/minecraft/entity/passive/EntityVillager;
        // 76: getfield net/minecraft/entity/passive/EntityVillager.field_70163_u D
        // 79: aload 0
        // 7a: getfield com/trolmastercard/sexmod/cw.c Lnet/minecraft/entity/passive/EntityVillager;
        ...
        // 85: aload 0
        // 86: getfield com/trolmastercard/sexmod/cw.a Lnet/minecraft/world/World;
        // 89: aload 1
        // 8a: invokevirtual net/minecraft/world/World.func_72838_d (Lnet/minecraft/entity/Entity;)Z
        // 8d: pop
        // 8e: aload 0
        // 8f: getfield com/trolmastercard/sexmod/cw.a Lnet/minecraft/world/World;
        // 92: aload 1
        // 93: bipush 12
