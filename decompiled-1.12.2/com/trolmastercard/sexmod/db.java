...
public class db extends dm {
    ...
    protected void a(boolean param1, boolean param2) {
        ...
        // 0b: ifne 3a
        // 0e: goto 15
        // 11: invokestatic com/trolmastercard/sexmod/db.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 14: athrow
        // 15: dconst_0
        // 16: ldc2_w -0.1
        // 19: ldc2_w 0.05
        ...
        // 35: return
        // 36: invokestatic com/trolmastercard/sexmod/db.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 39: athrow
        // 3a: iload 1
        // 3b: ifeq 58
        // 3e: iload 2
        // 3f: ifne 58
        // 42: goto 49
        // 45: invokestatic com/trolmastercard/sexmod/db.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 48: athrow
        // 49: ldc2_w -0.025
        // 4c: ldc2_w -0.1
        // 4f: dconst_0
        ...
        // 53: return
        // 54: invokestatic com/trolmastercard/sexmod/db.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 57: athrow
        // 58: return
