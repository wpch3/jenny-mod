...
public class b5 extends GuiScreen {
    ...
    protected void func_146284_a(GuiButton param1) {
        ...
        // 0c: aload 0
        // 0d: dup
        // 0e: getfield com/trolmastercard/sexmod/b5.b I
        // 11: bipush 1
        // 12: iadd
        // 13: dup_x1
        // 14: putfield com/trolmastercard/sexmod/b5.b I
        // 17: aload 0
        // 18: getfield com/trolmastercard/sexmod/b5.a Ljava/util/List;
        // 1b: invokeinterface java/util/List.size ()I 1
        // 20: if_icmplt 36
        // 23: goto 2a
        // 26: invokestatic com/trolmastercard/sexmod/b5.a (Ljava/lang/Exception;)Ljava/lang/Exception;
        // 29: athrow
        // 2a: aload 0
        // 2b: bipush 0
        // 2c: putfield com/trolmastercard/sexmod/b5.b I
        // 2f: goto 36
        // 32: invokestatic com/trolmastercard/sexmod/b5.a (Ljava/lang/Exception;)Ljava/lang/Exception;
        // 35: athrow
        // 36: ldc "<"
        // 38: aload 1
        ...
        // 42: aload 0
        // 43: dup
        // 44: getfield com/trolmastercard/sexmod/b5.b I
        // 47: bipush 1
        // 48: isub
        // 49: dup_x1
        // 4a: putfield com/trolmastercard/sexmod/b5.b I
        // 4d: ifge 6d
        // 50: goto 57
        // 53: invokestatic com/trolmastercard/sexmod/b5.a (Ljava/lang/Exception;)Ljava/lang/Exception;
        // 56: athrow
        // 57: aload 0
        // 58: aload 0
        // 59: getfield com/trolmastercard/sexmod/b5.a Ljava/util/List;
        // 5c: invokeinterface java/util/List.size ()I 1
        // 61: bipush 1
        // 62: isub
        // 63: putfield com/trolmastercard/sexmod/b5.b I
        // 66: goto 6d
        // 69: invokestatic com/trolmastercard/sexmod/b5.a (Ljava/lang/Exception;)Ljava/lang/Exception;
        // 6c: athrow
        // 6d: aload 1
        // 6e: getfield net/minecraft/client/gui/GuiButton.field_146127_k I
        // 71: ifne c6
        // 74: getstatic com/trolmastercard/sexmod/ge.b Lnet/minecraftforge/fml/common/network/simpleimpl/SimpleNetworkWrapper;
        // 77: new com/trolmastercard/sexmod/b_
        // 7a: dup
        // 7b: aload 0
        // 7c: getfield com/trolmastercard/sexmod/b5.a Ljava/util/List;
        // 7f: aload 0
        // 80: getfield com/trolmastercard/sexmod/b5.b I
        // 83: invokeinterface java/util/List.get (I)Ljava/lang/Object; 2
        // 88: checkcast net/minecraft/entity/Entity
        // 8b: invokestatic com/trolmastercard/sexmod/fy.a (Lnet/minecraft/entity/Entity;)Lcom/trolmastercard/sexmod/fy;
        // 8e: invokespecial com/trolmastercard/sexmod/b_.<init> (Lcom/trolmastercard/sexmod/fy;)V
        ...
        // bf: goto c6
        // c2: invokestatic com/trolmastercard/sexmod/b5.a (Ljava/lang/Exception;)Ljava/lang/Exception;
        // c5: athrow
        // c6: return
