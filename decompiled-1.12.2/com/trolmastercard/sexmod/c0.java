...
public class c0 extends cv {
    ...
    public void a(em param1, Integer param2, AnimationEvent param3) {
        ...
        // 07: aload 1
        // 08: getfield com/trolmastercard/sexmod/em.field_70170_p Lnet/minecraft/world/World;
        // 0b: instanceof com/trolmastercard/sexmod/gj
        // 0e: ifeq 16
        // 11: return
        // 12: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 15: athrow
        // 16: aload 0
        // 17: invokevirtual com/trolmastercard/sexmod/c0.getAnimationProcessor ()Lsoftware/bernie/geckolib3/core/processor/AnimationProcessor;
        // 1a: astore 4
        // 1c: aload 4
        // 1e: ldc "chest"
        ...
        // 27: ifnonnull 2f
        // 2a: return
        // 2b: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 2e: athrow
        // 2f: aload 5
        // 31: aload 1
        // 32: getfield com/trolmastercard/sexmod/em.E Lsoftware/bernie/geckolib3/core/controller/AnimationController;
        ...
        // 38: ifnull 54
        // 3b: aload 1
        // 3c: getfield com/trolmastercard/sexmod/em.E Lsoftware/bernie/geckolib3/core/controller/AnimationController;
        ...
        // 4a: ifne 5c
        // 4d: goto 54
        // 50: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 53: athrow
        // 54: bipush 1
        // 55: goto 5d
        // 58: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 5b: athrow
        // 5c: bipush 0
    ...
    protected void a(em param1, AnimationProcessor param2, AnimationEvent param3) {
        ...
        // 07: ifne b6
        // 0a: aload 1
        // 0b: invokevirtual com/trolmastercard/sexmod/em.y ()Lcom/trolmastercard/sexmod/fp;
        // 0e: getstatic com/trolmastercard/sexmod/fp.NULL Lcom/trolmastercard/sexmod/fp;
        // 11: if_acmpeq 3d
        // 14: goto 1b
        // 17: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 1a: athrow
        // 1b: aload 1
        // 1c: invokevirtual com/trolmastercard/sexmod/em.y ()Lcom/trolmastercard/sexmod/fp;
        // 1f: getstatic com/trolmastercard/sexmod/fp.ATTACK Lcom/trolmastercard/sexmod/fp;
        // 22: if_acmpeq 3d
        // 25: goto 2c
        // 28: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 2b: athrow
        // 2c: aload 1
        // 2d: invokevirtual com/trolmastercard/sexmod/em.y ()Lcom/trolmastercard/sexmod/fp;
        // 30: getstatic com/trolmastercard/sexmod/fp.BOW Lcom/trolmastercard/sexmod/fp;
        // 33: if_acmpne b6
        // 36: goto 3d
        // 39: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 3c: athrow
        // 3d: aload 3
        ...
        // 9f: goto ac
        // a2: invokestatic com/trolmastercard/sexmod/c0.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // a5: athrow
        // a6: aload 2
        // a7: ldc "body"
