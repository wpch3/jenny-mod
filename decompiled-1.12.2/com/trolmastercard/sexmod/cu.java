...
public class cu implements IMessage {
    ...
    public cu(List<String> var1) {
        this.c = var1;
    }

    public cu(byte[] var1, cu.b var2, String var3) {
        this.b = var1;
        this.f = var2;
        this.e = var3;
    }
    ...
    public void fromBytes(ByteBuf param1) {
        ...
        // 06: ifeq 63
        // 09: invokestatic com/trolmastercard/sexmod/br.b ()Z
        // 0c: ifne 1b
        // 0f: goto 16
        // 12: invokestatic com/trolmastercard/sexmod/cu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 15: athrow
        // 16: return
        // 17: invokestatic com/trolmastercard/sexmod/cu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 1a: athrow
        // 1b: aload 0
        // 1c: aload 1
        // 1d: invokestatic net/minecraftforge/fml/common/network/ByteBufUtils.readUTF8String (Lio/netty/buffer/ByteBuf;)Ljava/lang/String;
        // 20: putfield com/trolmastercard/sexmod/cu.e Ljava/lang/String;
        // 23: aload 0
        // 24: aload 1
        // 25: invokestatic net/minecraftforge/fml/common/network/ByteBufUtils.readUTF8String (Lio/netty/buffer/ByteBuf;)Ljava/lang/String;
        // 28: invokestatic com/trolmastercard/sexmod/cu$b.valueOf (Ljava/lang/String;)Lcom/trolmastercard/sexmod/cu$b;
        // 2b: putfield com/trolmastercard/sexmod/cu.f Lcom/trolmastercard/sexmod/cu$b;
        // 2e: aload 0
        // 2f: aload 1
        // 30: invokevirtual io/netty/buffer/ByteBuf.readInt ()I
        // 33: putfield com/trolmastercard/sexmod/cu.a I
        // 36: aload 1
        // 37: invokevirtual io/netty/buffer/ByteBuf.readInt ()I
        // 3a: istore 2
        // 3b: aload 0
        // 3c: iload 2
        // 3d: newarray 8
        // 3f: putfield com/trolmastercard/sexmod/cu.b [B
        // 42: bipush 0
        // 43: istore 3
        // 44: iload 3
        // 45: iload 2
        // 46: if_icmpge 5d
        // 49: aload 0
        // 4a: getfield com/trolmastercard/sexmod/cu.b [B
        // 4d: iload 3
        // 4e: aload 1
        // 4f: invokevirtual io/netty/buffer/ByteBuf.readByte ()B
        // 52: bastore
        // 53: iinc 3 1
        // 56: goto 44
        // 59: invokestatic com/trolmastercard/sexmod/cu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 5c: athrow
        // 5d: aload 0
        // 5e: bipush 1
        // 5f: putfield com/trolmastercard/sexmod/cu.d Z
        // 62: return
        // 63: aload 1
        // 64: invokevirtual io/netty/buffer/ByteBuf.readInt ()I
        // 67: istore 2
        // 68: bipush 0
        // 69: istore 3
        // 6a: iload 3
        ...
        // 6c: if_icmpge 87
        // 6f: aload 0
        // 70: getfield com/trolmastercard/sexmod/cu.c Ljava/util/List;
        // 73: aload 1
        // 74: invokestatic net/minecraftforge/fml/common/network/ByteBufUtils.readUTF8String (Lio/netty/buffer/ByteBuf;)Ljava/lang/String;
        // 77: invokeinterface java/util/List.add (Ljava/lang/Object;)Z 2
        // 7c: pop
        // 7d: iinc 3 1
        // 80: goto 6a
        // 83: invokestatic com/trolmastercard/sexmod/cu.a (Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;
        // 86: athrow
        // 87: aload 0
        // 88: bipush 1
        // 89: putfield com/trolmastercard/sexmod/cu.d Z
        // 8c: return
        // try (0 -> 5): 6 java/lang/RuntimeException
        // try (3 -> 9): 9 java/lang/RuntimeException
        // try (33 -> 44): 44 java/lang/RuntimeException
        // try (55 -> 66): 66 java/lang/RuntimeException
    }
    ...
    public static class a implements IMessageHandler<cu, IMessage> {
        ...
        public IMessage a(cu param1, MessageContext param2) {
            // $VF: Couldn't be decompiled
            // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
            // java.lang.RuntimeException: parsing failure!
            //   at org.jetbrains.java.decompiler.modules.decompiler.decompose.DomHelper.parseGraph(DomHelper.java:211)
            ...
            // Bytecode:
            // 000: aload 1
            // 001: getfield com/trolmastercard/sexmod/cu.d Z
            // 004: ifne 015
            ...
            // 00f: aconst_null
            // 010: areturn
            // 011: invokestatic com/trolmastercard/sexmod/cu$a.a (Ljava/lang/Throwable;)Ljava/lang/Throwable;
            // 014: athrow
            // 015: aload 2
            ...
            // 01c: ifeq 1fb
            // 01f: invokestatic com/trolmastercard/sexmod/br.b ()Z
            // 022: ifne 032
            // 025: goto 02c
            // 028: invokestatic com/trolmastercard/sexmod/cu$a.a (Ljava/lang/Throwable;)Ljava/lang/Throwable;
            // 02b: athrow
            // 02c: aconst_null
            // 02d: areturn
            // 02e: invokestatic com/trolmastercard/sexmod/cu$a.a (Ljava/lang/Throwable;)Ljava/lang/Throwable;
            // 031: athrow
            // 032: aload 1
            // 033: getfield com/trolmastercard/sexmod/cu.e Ljava/lang/String;
            // 036: astore 3
            // 037: aload 1
            // 038: getfield com/trolmastercard/sexmod/cu.f Lcom/trolmastercard/sexmod/cu$b;
            // 03b: astore 4
            // 03d: aload 1
            // 03e: getfield com/trolmastercard/sexmod/cu.b [B
            // 041: astore 5
            // 043: new java/lang/StringBuilder
            // 046: dup
            // 047: invokespecial java/lang/StringBuilder.<init> ()V
            // 04a: invokestatic com/trolmastercard/sexmod/br.h ()Ljava/lang/String;
            ...
            // 088: aload 4
            // 08a: getfield com/trolmastercard/sexmod/cu$b.ending Ljava/lang/String;
            ...
            // 0e5: ifnull 103
            // 0e8: goto 0ef
            // 0eb: invokestatic com/trolmastercard/sexmod/cu$a.a (Ljava/lang/Throwable;)Ljava/lang/Throwable;
            // 0ee: athrow
            // 0ef: aload 9
            ...
            // 115: bipush 0
            // 116: istore 9
            // 118: invokestatic com/trolmastercard/sexmod/cu$b.values ()[Lcom/trolmastercard/sexmod/cu$b;
            // 11b: arraylength
            // 11c: istore 10
            // 11e: invokestatic com/trolmastercard/sexmod/cu$b.values ()[Lcom/trolmastercard/sexmod/cu$b;
            // 121: astore 11
            // 123: aload 11
            // 125: arraylength
            // 126: istore 12
            ...
            // 152: aload 14
            // 154: getfield com/trolmastercard/sexmod/cu$b.ending Ljava/lang/String;
            ...
            // 166: iinc 9 1
            // 169: goto 170
            // 16c: invokestatic com/trolmastercard/sexmod/cu$a.a (Ljava/lang/Throwable;)Ljava/lang/Throwable;
            // 16f: athrow
            // 170: iinc 13 1
            // 173: goto 12b
            // 176: iload 9
            ...
            // 19d: invokevirtual com/trolmastercard/sexmod/cu$a.a (Ljava/lang/String;)V
            // 1a0: goto 1db
            // 1a3: invokestatic com/trolmastercard/sexmod/cu$a.a (Ljava/lang/Throwable;)Ljava/lang/Throwable;
            // 1a6: athrow
            // 1a7: aload 0
            ...
            // 1d8: invokevirtual com/trolmastercard/sexmod/cu$a.a (Ljava/lang/String;)V
            // 1db: getstatic com/trolmastercard/sexmod/cu$a.a I
            // 1de: bipush 1
            // 1df: iadd
            // 1e0: dup
            // 1e1: putstatic com/trolmastercard/sexmod/cu$a.a I
            // 1e4: aload 1
            // 1e5: getfield com/trolmastercard/sexmod/cu.a I
            // 1e8: if_icmpge 1f1
            // 1eb: aconst_null
            // 1ec: areturn
            // 1ed: invokestatic com/trolmastercard/sexmod/cu$a.a (Ljava/lang/Throwable;)Ljava/lang/Throwable;
            // 1f0: athrow
            // 1f1: bipush 0
            // 1f2: putstatic com/trolmastercard/sexmod/cu$a.a I
            // 1f5: aload 0
            // 1f6: invokevirtual com/trolmastercard/sexmod/cu$a.a ()V
            // 1f9: aconst_null
            // 1fa: areturn
            ...
            // 204: aload 3
            // 205: aload 2
            // 206: invokedynamic run (Lcom/trolmastercard/sexmod/cu;Lnet/minecraft/server/MinecraftServer;Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)Ljava/lang/Runnable; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ ()V, com/trolmastercard/sexmod/cu$a.lambda$onMessage$2 (Lcom/trolmastercard/sexmod/cu;Lnet/minecraft/server/MinecraftServer;Lnet/minecraftforge/fml/common/network/simpleimpl/MessageContext;)V, ()V ]
