...
public final class Fraction extends Number implements Comparable<Fraction> {
    ...
    public static Fraction getFraction(int whole, int numerator, int denominator) {
        ...
        long numeratorValue;
        if (whole < 0) {
            numeratorValue = (long)whole * denominator - numerator;
        } else {
            numeratorValue = (long)whole * denominator + numerator;
        }
    ...
    public static Fraction getFraction(double value) {
        ...
        if (!(value > 2.147483647E9) && !Double.isNaN(value)) {
            ...
            do {
                ...
                double fraction = (double)numer2 / denom2;
    ...
    public Fraction multiplyBy(Fraction fraction) {
        ...
        if (this.numerator != 0 && fraction.numerator != 0) {
            ...
            return getReducedFraction(
                mulAndCheck(this.numerator / d1, fraction.numerator / d2), mulPosAndCheck(this.denominator / d2, fraction.denominator / d1)
            );
        } else {
            return ZERO;
        }
    ...
    public int compareTo(Fraction other) {
        ...
        long first = (long)this.numerator * other.denominator;
        long second = (long)other.numerator * this.denominator;
